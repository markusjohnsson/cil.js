var asm1;(function (asm)
{
    ...
    asm.x6000005 = function (T, T2)
    {
        return function Baz(arg0, arg1)
        {
            ...
            /* IL_28: ldc.i4.0  */
            /* IL_29: newarr System.Object */
            /* IL_2E: call Void WriteLine(System.String, System.Object[]) */
            ...
            /* IL_33: ldarga.s 1 */
            /* IL_3B: callvirt Type GetType() */
            /* IL_40: callvirt String get_FullName() */
            /* IL_45: ldc.i4.0  */
    ...
    asm.x6000008_ = function Main()
    {
        ...
        asm1.x6000003(CILJS.newobj(t1,asm1.x6000007,[null]),(123|0));
        /* IL_0C: newobj Void .ctor() */
        /* IL_11: ldstr A */
        /* IL_16: call Void Foo(System.String) */
        asm1.x6000003(CILJS.newobj(t3,asm1.x6000007,[null]),CILJS.new_string("A"));
        /* IL_1B: ldc.i4.s 123 */
        /* IL_1D: call Void Bar(System.Int32) */
        (asm1.x6000004((asm0)["System.Int32"]()))((123|0));
        /* IL_22: ldstr B */
        /* IL_27: call Void Bar(System.String) */
        (asm1.x6000004((asm0)["System.String"]()))(CILJS.new_string("B"));
        /* IL_2C: ldc.i4.s 123 */
        /* IL_2E: ldstr C */
        /* IL_33: call Void Baz[System.String](System.Int32, System.String) */
        (asm1.x6000005((asm0)["System.Int32"](),(asm0)["System.String"]()))((123|0),CILJS.new_string("C"));
        /* IL_38: newobj Void .ctor() */
        /* IL_3D: ldstr C */
        /* IL_42: ldc.i4 321 */
        /* IL_47: call Void Buz[System.Int32](System.String, System.Int32) */
        (asm1.x6000006((asm0)["System.Int32"]()))(CILJS.newobj(t3,asm1.x6000007,[null]),CILJS.new_string("C"),(321|0));
        /* IL_4C: ret  */
        return ;
    };
    /*  Program..ctor()*/
    ...
    (asm)["A`1+B"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"A`1+B",false,false,false,true,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000003");
