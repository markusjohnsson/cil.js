var asm1;(function (asm)
{
    ...
    asm.x600000a = function get_Name(arg0)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_2A: stloc.3  */
                loc3 = CILJS.new_array(t0,(4|0));
                /* IL_2B: ldloc.3  */
                /* IL_2C: ldc.i4.0  */
                /* IL_2D: ldarg.0  */
                /* IL_2E: ldfld String name */
                /* IL_33: stelem.ref  */
                CILJS.stelem_ref(loc3,(0|0),arg0.Bazname);
                /* IL_34: ldloc.3  */
                /* IL_35: ldc.i4.1  */
                /* IL_36: ldstr  ( */
                /* IL_3B: stelem.ref  */
                CILJS.stelem_ref(loc3,(1|0),CILJS.new_string(" ("));
                /* IL_3C: ldloc.3  */
                /* IL_3D: ldc.i4.2  */
                /* IL_3E: ldarg.0  */
                ...
                /* IL_4C: ldstr ) */
                /* IL_51: stelem.ref  */
                CILJS.stelem_ref(loc3,(3|0),CILJS.new_string(")"));
                /* IL_52: ldloc.3  */
    ...
    asm.x600000e_ = function Equals(arg0, arg1)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                if (CILJS.unsigned_value(asm1.x600000b(loc0)) != CILJS.unsigned_value(asm1.x600000b(arg0))){
                    __pos__ = 0x38;
                    continue;
                }
                /* IL_25: ldloc.0  */
    ...
    asm.x6000014_ = function CreateBazCollection()
    {
        ...
        /* IL_16: stelem.ref  */
        CILJS.stelem_ref(loc1,(0|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("jb"), (25|0)]));
        /* IL_17: ldloc.1  */
        /* IL_18: ldc.i4.1  */
        /* IL_19: ldstr ana */
        /* IL_1E: ldc.i4.s 20 */
        ...
        /* IL_25: stelem.ref  */
        CILJS.stelem_ref(loc1,(1|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("ana"), (20|0)]));
        /* IL_26: ldloc.1  */
        /* IL_27: ldc.i4.2  */
        /* IL_28: ldstr reg */
        /* IL_2D: ldc.i4.s 28 */
        ...
        /* IL_34: stelem.ref  */
        CILJS.stelem_ref(loc1,(2|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("reg"), (28|0)]));
        /* IL_35: ldloc.1  */
        /* IL_36: ldc.i4.3  */
        /* IL_37: ldstr ro */
        /* IL_3C: ldc.i4.s 25 */
        ...
        /* IL_43: stelem.ref  */
        CILJS.stelem_ref(loc1,(3|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("ro"), (25|0)]));
        /* IL_44: ldloc.1  */
        /* IL_45: ldc.i4.4  */
        /* IL_46: ldstr jb */
        /* IL_4B: ldc.i4.7  */
        ...
        /* IL_51: stelem.ref  */
        CILJS.stelem_ref(loc1,(4|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("jb"), (7|0)]));
        /* IL_52: ldloc.1  */
        /* IL_53: stloc.0  */
        loc0 = loc1;
        /* IL_56: ldloc.0  */
    ...
    asm.x6000015_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                (asm0.x600017e(asm1.Baz()))(loc0,CILJS.newobj(t0,asm1.x6000013,[null]));
                /* IL_1D: nop  */
                ...
                (asm0.x600017e(asm1.Baz()))(loc2,CILJS.newobj(t2,asm1.x6000011,[null]));
                /* IL_57: nop  */
                ...
                asm1.x6000001(CILJS.ldelem_ref(loc2,loc1));
                /* IL_65: nop  */
    ...
    asm.Baz = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.declare_virtual(this,"asm0.x6000009","asm1.x600000d");
            CILJS.declare_virtual(this,"asm0.x6000008","asm1.x600000e");
            CILJS.declare_virtual(this,"asm0.x6000005","asm1.x600000f");
