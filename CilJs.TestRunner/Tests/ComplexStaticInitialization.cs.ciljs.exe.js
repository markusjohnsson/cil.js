var asm1;(function (asm)
{
        ...
        return function _cctor()
        {
            ...
            while (in_block_0){
                ...
                switch (__pos__){
                    ...
                    if ((((asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)).vtable)["asm0.x60000ed"])())(asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)),asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t0)))){
                        __pos__ = 0x22;
                        continue;
                    }
                    (asm1.x600000b(T))();
                    /* IL_1B: newobj Void .ctor() */
                    st_10 = CILJS.newobj(t2,asm1.x600000c,[null]);
                    /* IL_20: br.s IL_50 */
                    __pos__ = 0x50;
                    continue;
                    case 0x22:
                    ...
                    st_0C = asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t5));
                    /* IL_2C: ldc.i4.1  */
    ...
    (asm)["A`1"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"A`1",false,false,false,true,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000007");
            this.Instance = null;
    ...
    (asm)["B`1"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"B`1",false,false,false,true,false,[],[],(asm1)["A`1"](T),CILJS.is_inst_default(this),Array,"asm1.t2000008");
    ...
    (asm)["C`1"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"C`1",false,false,false,true,false,[],[],(asm1)["A`1"](T),CILJS.is_inst_default(this),Array,"asm1.t2000009");
    ...
    asm.E = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"E",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t200000b");
