var asm1;(function (asm)
{
    ...
    asm.x6000002_ = function Main()
    {
        ...
        asm1.x6000003(CILJS.clone_value(loc23));
        /* IL_0F: ldloca.s 0 */
        /* IL_12: initobj A */
        loc0 = new t0();
        /* IL_17: ldloca.s 0 */
        ...
        asm1.x6000003(CILJS.clone_value(loc1));
        /* IL_3C: ldloca.s 2 */
        /* IL_3F: initobj A */
        loc2 = new t0();
        /* IL_44: ldloca.s 2 */
        ...
        asm1.x6000003(CILJS.clone_value(loc24));
        /* IL_65: ldloca.s 25 */
        /* IL_68: initobj B */
        loc25 = new t1();
        /* IL_6D: ldloc.s 25 */
        ...
        asm1.x6000003(CILJS.clone_value(loc25.a));
        ...
        asm1.x6000004(CILJS.clone_value(loc26));
        /* IL_92: ldloca.s 3 */
        /* IL_95: initobj B */
        loc3 = new t1();
        /* IL_9A: ldloca.s 3 */
        ...
        asm1.x6000004(CILJS.clone_value(loc3));
        /* IL_BA: ldloca.s 5 */
        /* IL_BD: initobj B */
        loc5 = new t1();
        /* IL_C2: ldloca.s 5 */
        ...
        asm1.x6000004(CILJS.clone_value(loc5));
        /* IL_EB: ldloca.s 7 */
        /* IL_EE: initobj B */
        loc7 = new t1();
        /* IL_F3: ldloca.s 7 */
        ...
        asm1.x6000004(CILJS.clone_value(loc7));
        /* IL_120: ldloca.s 9 */
        /* IL_123: initobj B */
        loc9 = new t1();
        /* IL_128: ldloca.s 9 */
        ...
        asm1.x6000004(CILJS.clone_value(loc9));
        /* IL_155: ldloca.s 11 */
        /* IL_158: initobj B */
        loc11 = new t1();
        /* IL_15D: ldloca.s 11 */
        ...
        /* IL_17E: stfld C c */
        loc11.c = CILJS.newobj(t2,asm1.x6000001,[null]);
        /* IL_183: ldloc.s 11 */
        /* IL_185: call Void TestB(B) */
        asm1.x6000004(CILJS.clone_value(loc11));
        /* IL_18A: ldloca.s 13 */
        /* IL_18D: initobj B */
        loc13 = new t1();
        /* IL_192: ldloca.s 13 */
        ...
        asm1.x6000004(CILJS.clone_value(loc13));
        /* IL_1B3: ldloca.s 15 */
        /* IL_1B6: initobj B */
        loc15 = new t1();
        /* IL_1BB: ldloca.s 15 */
        ...
        asm1.x6000004(CILJS.clone_value(loc15));
        /* IL_1E4: ldloca.s 17 */
        /* IL_1E7: initobj B */
        loc17 = new t1();
        /* IL_1EC: ldloca.s 17 */
        ...
        asm1.x6000004(CILJS.clone_value(loc17));
        /* IL_219: ldloca.s 19 */
        /* IL_21C: initobj B */
        loc19 = new t1();
        /* IL_221: ldloca.s 19 */
        ...
        asm1.x6000004(CILJS.clone_value(loc19));
        /* IL_24E: ldloca.s 21 */
        /* IL_251: initobj B */
        loc21 = new t1();
        /* IL_256: ldloca.s 21 */
        ...
        /* IL_277: stfld C c */
        loc21.c = CILJS.newobj(t2,asm1.x6000001,[null]);
        /* IL_27C: ldloc.s 21 */
        /* IL_27E: call Void TestB(B) */
        asm1.x6000004(CILJS.clone_value(loc21));
        /* IL_283: ret  */
        return ;
    };
    ...
    asm.x6000003_ = function TestA(arg0)
    {
        ...
        /* IL_78: call Void WriteLine(System.Object) */
        asm0.x600005a({
                'boxed': (((arg0.vtable || t0.prototype.vtable)["asm0.x60000f0"])())({
                        'w': function (v)
                        {
        ...
        /* IL_AE: call Void WriteLine(System.Object) */
        asm0.x600005a({
                'boxed': asm0.x60000ef({
                        'boxed': CILJS.clone_value(arg0),
                        'type': t0,
        ...
        /* IL_C9: call Void WriteLine(System.Object) */
        asm0.x600005a({
                'boxed': asm0.x60000ef({
                        'boxed': CILJS.clone_value(arg0),
                        'type': t0,
    ...
    asm.x6000004_ = function TestB(arg0)
    {
        ...
        /* IL_AF: call Void WriteLine(System.Object) */
        asm0.x600005a({
                'boxed': (((arg0.vtable || t0.prototype.vtable)["asm0.x60000f0"])())({
                        'w': function (v)
                        {
        ...
        /* IL_E5: call Void WriteLine(System.Object) */
        asm0.x600005a({
                'boxed': asm0.x60000ef({
                        'boxed': CILJS.clone_value(arg0),
                        'type': t0,
