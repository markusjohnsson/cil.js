var asm1;(function (asm)
{
    ...
    asm.x600000e_ = function Main()
    {
        ...
        asm1.x6000001({
                'boxed': ((asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t2)) === asm0.x60000e1(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t5))) ? (1) : (0)),
                'type': t6,
    ...
    (asm)["K`1"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"K`1",false,false,false,true,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000007");
    ...
    asm.Y = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"Y",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000009");
