var asm1;(function (asm)
{
    ...
    asm.x600000d_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_10: ceq  */
                /* IL_11: stloc.2  */
                loc2 = (((((loc0.ifacemap)[t1].x600000a)())(CILJS.convert_box_to_pointer_as_needed(loc0)) === (33|0)) ? (1) : (0));
                /* IL_12: ldloc.2  */
    ...
    asm.ProjectName = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"ProjectName",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000008");
