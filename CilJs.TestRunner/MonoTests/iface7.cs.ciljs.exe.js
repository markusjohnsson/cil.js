var asm1;(function (asm)
{
    ...
    asm.x600000f_ = function Main(arg0)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_0F: ceq  */
                /* IL_10: stloc.s 5 */
                loc5 = (((((loc0.ifacemap)[t1].x600000a)())(CILJS.convert_box_to_pointer_as_needed(loc0)) === (2|0)) ? (1) : (0));
                /* IL_12: ldloc.s 5 */
                ...
                /* IL_25: ceq  */
                /* IL_26: stloc.s 5 */
                loc5 = (((((loc1.ifacemap)[t1].x600000a)())(CILJS.convert_box_to_pointer_as_needed(loc1)) === (2|0)) ? (1) : (0));
                /* IL_28: ldloc.s 5 */
    ...
    (asm)["TestMono.IDerived"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"TestMono.IDerived",false,false,true,false,false,[],[],null,CILJS.is_inst_interface(this),Array,"asm1.t2000007");
    ...
    (asm)["TestMono.Derived"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"TestMono.Derived",false,false,false,false,false,[],[],(asm1)["TestMono.Base"](),CILJS.is_inst_default(this),Array,"asm1.t2000009");
    ...
    (asm)["TestMono.Class1"] = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"TestMono.Class1",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t200000a");
