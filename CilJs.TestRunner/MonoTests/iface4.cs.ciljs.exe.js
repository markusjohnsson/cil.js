var asm1;(function (asm)
{
    ...
    asm.x600001b_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                case 0x0:
                /* IL_00: nop  iface4.cs:49:5*/
                
                /* IL_01: newobj Void .ctor() */
                /* IL_06: stloc.0  */
                loc0 = CILJS.newobj(t0,asm1.x6000014,[null]);
                /* IL_07: newobj Void .ctor() */
                /* IL_0C: stloc.1  */
                loc1 = CILJS.newobj(t1,asm1.x6000019,[null]);
                /* IL_0D: newobj Void .ctor() */
                /* IL_12: stloc.2  */
                loc2 = CILJS.newobj(t2,asm1.x600001a,[null]);
                /* IL_13: ldloc.0  */
                /* IL_14: stloc.3  */
                loc3 = loc0;
                /* IL_15: ldloc.1  */
                ...
                /* IL_1D: stloc.s 5 */
                loc5 = CILJS.newobj(t3,asm1.x6000012,[null]);
                /* IL_1F: ldloc.0  */
                /* IL_20: callvirt Int32 Turn() */
                /* IL_25: ldc.i4.4  */
                /* IL_27: ceq  */
                /* IL_28: stloc.s 7 */
                loc7 = ((((loc0.vtable)["asm1.x6000010"]())(loc0) === (4|0)) ? (1) : (0));
                /* IL_2A: ldloc.s 7 */
                /* IL_2C: brtrue.s IL_36 */
                ...
                case 0x36:
                /* IL_36: ldloc.0  */
                /* IL_37: callvirt Int32 Turn() */
                /* IL_3C: ldc.i4.4  */
                /* IL_3E: ceq  */
                /* IL_3F: stloc.s 7 */
                loc7 = (((((loc0.ifacemap)[t4].x600000c)())(loc0) === (4|0)) ? (1) : (0));
                /* IL_41: ldloc.s 7 */
                /* IL_43: brtrue.s IL_4D */
                ...
                case 0x4D:
                /* IL_4D: ldloc.1  */
                /* IL_4E: callvirt Int32 Turn() */
                /* IL_53: ldc.i4.8  */
                /* IL_55: ceq  */
                /* IL_56: stloc.s 7 */
                loc7 = ((((loc1.vtable)["asm1.x6000010"]())(loc1) === (8|0)) ? (1) : (0));
                /* IL_58: ldloc.s 7 */
                /* IL_5A: brtrue.s IL_65 */
                ...
                case 0x65:
                /* IL_65: ldloc.1  */
                /* IL_66: callvirt Int32 Turn() */
                /* IL_6B: ldc.i4.7  */
                /* IL_6D: ceq  */
                /* IL_6E: stloc.s 7 */
                loc7 = (((((loc1.ifacemap)[t4].x600000c)())(loc1) === (7|0)) ? (1) : (0));
                /* IL_70: ldloc.s 7 */
                /* IL_72: brtrue.s IL_7C */
                ...
                case 0x7C:
                /* IL_7C: ldloc.s 4 */
                /* IL_7E: callvirt Int32 Turn() */
                /* IL_83: ldc.i4.8  */
                /* IL_85: ceq  */
                /* IL_86: stloc.s 7 */
                loc7 = ((((loc4.vtable)["asm1.x6000010"]())(loc4) === (8|0)) ? (1) : (0));
                /* IL_88: ldloc.s 7 */
                /* IL_8A: brtrue.s IL_91 */
                ...
                case 0x91:
                /* IL_91: ldloc.s 4 */
                /* IL_93: callvirt Int32 Turn() */
                /* IL_98: ldc.i4.7  */
                /* IL_9A: ceq  */
                /* IL_9B: stloc.s 7 */
                loc7 = (((((loc4.ifacemap)[t4].x600000c)())(loc4) === (7|0)) ? (1) : (0));
                /* IL_9D: ldloc.s 7 */
                /* IL_9F: brtrue.s IL_A6 */
                ...
                case 0xA6:
                /* IL_A6: ldloc.s 5 */
                /* IL_A8: callvirt Int32 Stop() */
                /* IL_AD: ldc.i4.2  */
                /* IL_AF: ceq  */
                /* IL_B0: stloc.s 7 */
                loc7 = (((((loc5.ifacemap)[t4].x600000b)())(loc5) === (2|0)) ? (1) : (0));
                /* IL_B2: ldloc.s 7 */
                /* IL_B4: brtrue.s IL_BB */
                ...
                case 0xBB:
                /* IL_BB: ldloc.0  */
                /* IL_BC: callvirt Int32 Stop() */
                /* IL_C1: ldc.i4.2  */
                /* IL_C3: ceq  */
                /* IL_C4: stloc.s 7 */
                loc7 = (((((loc0.ifacemap)[t4].x600000b)())(loc0) === (2|0)) ? (1) : (0));
                /* IL_C6: ldloc.s 7 */
                /* IL_C8: brtrue.s IL_CF */
                ...
                case 0xCF:
                /* IL_CF: ldloc.1  */
                /* IL_D0: callvirt Int32 Stop() */
                /* IL_D5: ldc.i4.6  */
                /* IL_D7: ceq  */
                /* IL_D8: stloc.s 7 */
                loc7 = (((((loc1.ifacemap)[t4].x600000b)())(loc1) === (6|0)) ? (1) : (0));
                /* IL_DA: ldloc.s 7 */
                /* IL_DC: brtrue.s IL_E3 */
                ...
                case 0xE3:
                /* IL_E3: ldloc.2  */
                /* IL_E4: callvirt Int32 Walk() */
                /* IL_E9: ldc.i4.1  */
                /* IL_EB: ceq  */
                /* IL_EC: stloc.s 7 */
                loc7 = ((((loc2.vtable)["asm1.x6000011"]())(loc2) === (1|0)) ? (1) : (0));
                /* IL_EE: ldloc.s 7 */
                /* IL_F0: brtrue.s IL_F8 */
    ...
    asm.Derived1 = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"Derived1",false,false,false,false,false,[],[
                    [asm1, "x6000013", "Turn"]
                ],asm1.Base(),CILJS.is_inst_default(this),Array,"asm1.t2000009");
            this.GenericTypeMetadataName = "asm1.t2000009";
            CILJS.declare_virtual(this,"asm1.x6000010","asm1.x6000013");
            CILJS.declare_virtual(this,"asm1.x600000f","asm1.x600000f");
            CILJS.declare_virtual(this,"asm1.x6000011","asm1.x6000011");
            CILJS.declare_virtual(this,"asm0.x6000005","asm0.x6000005");
            CILJS.declare_virtual(this,"asm0.x6000008","asm0.x6000008");
    ...
    asm.Derived2 = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"Derived2",false,false,false,false,false,[],[
                    [asm1, "x6000015", "Stop"],
                    [asm1, "x6000018", "Turn"]
                ],asm1.Base(),CILJS.is_inst_default(this),Array,"asm1.t200000a");
            ...
            CILJS.declare_virtual(this,"asm1.x6000010","asm1.x6000018");
            CILJS.declare_virtual(this,"asm1.x600000f","asm1.x600000f");
            CILJS.declare_virtual(this,"asm1.x6000011","asm1.x6000011");
            CILJS.declare_virtual(this,"asm0.x6000005","asm0.x6000005");
            CILJS.declare_virtual(this,"asm0.x6000008","asm0.x6000008");
    ...
    asm.Derived3 = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"Derived3",false,false,false,false,false,[],[],asm1.Derived1(),CILJS.is_inst_default(this),Array,"asm1.t200000b");
    ...
    asm.Test = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"Test",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t200000c");
