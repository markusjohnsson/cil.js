var asm1; (function (asm)
{
    ...
    asm.IC = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"IC",false,false,true,false,false,[],[
                    [asm1, "x600000d", "Add"]
                ],null,CILJS.is_inst_interface(this),Array,"asm1.t2000008");
    ...
    asm.ID = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"ID",false,false,true,false,false,[],[],null,CILJS.is_inst_interface(this),Array,"asm1.t2000009");
