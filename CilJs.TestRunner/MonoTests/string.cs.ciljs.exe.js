var asm1;(function (asm)
{
    ...
    asm.x600000a_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_3A: ceq  */
                /* IL_3B: stloc.s 4 */
                loc4 = ((asm0.x60001c5(loc2,asm0.x60001bb(loc1,CILJS.new_string("a"))) === (0|0)) ? (1) : (0));
                /* IL_3D: ldloc.s 4 */
                ...
                /* IL_58: ceq  */
                /* IL_59: stloc.s 4 */
                loc4 = ((asm0.x6000007(loc2,asm0.x60001bb(loc1,CILJS.new_string("a"))) === (0|0)) ? (1) : (0));
                /* IL_5B: ldloc.s 4 */
    ...
    asm.TestString = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"TestString",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t2000006");
