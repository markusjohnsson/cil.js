var asm1;(function (asm)
{
    ...
    asm.x6000013_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_06: stloc.0  */
                loc0 = CILJS.newobj(t0,asm1.x6000012,[null]);
                /* IL_07: ldloc.0  */
                /* IL_08: stloc.1  */
                loc1 = loc0;
                /* IL_09: ldloc.0  */
                ...
                /* IL_68: ceq  */
                /* IL_69: stloc.s 6 */
                loc6 = (((((loc3.ifacemap)[t1].x600000a)())(CILJS.convert_box_to_pointer_as_needed(loc3)) === (3|0)) ? (1) : (0));
                /* IL_6B: ldloc.s 6 */
    ...
    asm.Derived = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"Derived",false,false,false,false,false,[],[
                    [asm1, "x600000f", "DoIt"]
                ],asm1.Base(),CILJS.is_inst_default(this),Array,"asm1.t2000008");
    ...
    asm.ReallyDerived = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"ReallyDerived",false,false,false,false,false,[],[
                    [asm1, "x6000011", "DoIt"]
                ],asm1.Derived(),CILJS.is_inst_default(this),Array,"asm1.t2000009");
            this.GenericTypeMetadataName = "asm1.t2000009";
            CILJS.declare_virtual(this,"asm1.x600000f","asm1.x6000011");
            CILJS.declare_virtual(this,"asm1.x600000c","asm1.x600000c");
            CILJS.declare_virtual(this,"asm0.x6000005","asm0.x6000005");
            CILJS.declare_virtual(this,"asm0.x6000008","asm0.x6000008");
            CILJS.declare_virtual(this,"asm0.x6000009","asm0.x6000009");
    ...
    asm.Test = CILJS.declare_type(
        ...
        {
            this.init = CILJS.nop;
            CILJS.init_type(this,asm,"Test",false,false,false,false,false,[],[],(asm0)["System.Object"](),CILJS.is_inst_default(this),Array,"asm1.t200000a");
