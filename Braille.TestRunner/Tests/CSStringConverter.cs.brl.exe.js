...
;
    ...
    asm.x6000011_ = function Convert(arg0)
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                (asm1.x600000e)(loc0,(asm1.x6000012)((asm0.x600016b)(arg0,loc1)));
                /* IL_87: br.s IL_D7*/
                __pos_0__ = 0xD7;
                continue;
                case 0x89:
                ...
                (asm1.x600000f)(loc0,(asm0.x600016b)(arg0,loc1));
                case 0xD7:
                /* IL_D7: ldloc.1 */
                /* IL_D8: ldc.i4.1 */
                /* IL_D9: add */
    ...
    asm.x6000012_ = function EscapeChar(arg0)
    {
        ...
        /* IL_10: ret */
        return (asm0.x6000171)(new_string("\\u"),{
            'boxed': arg0,
            'type': t0,
            'vtable': t0.prototype.vtable,
            'ifacemap': t0.prototype.ifacemap
    ...
    asm.CSStringConverter = (function ()
    {
        ...
        return function ()
        {
            ...
            CSStringConverter.init = function ()
            {
                ...
                CSStringConverter.MetadataName = "asm1.t2000009";
                CSStringConverter.GenericArguments = {};
                (CSStringConverter.GenericArguments)["asm1.t2000009"] = [];
                (CSStringConverter.GenericArguments)["asm0.t2000002"] = [];
                ...
                CSStringConverter.prototype.ifacemap = {};
            };
