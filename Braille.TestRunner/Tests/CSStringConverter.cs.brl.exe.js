var asm1;(function (asm) 
{
    ...
    asm.x600000f_ = function Convert(arg0) 
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                __switch_value__ = BLR.unsigned_value((loc3 - (9|0)) | (0|0));
                ...
                __switch_value__ = BLR.unsigned_value((loc3 - (8232|0)) | (0|0));
    ...
    asm.x6000010 = function EscapeChar(arg0) 
    {
        ...
        /*IL_11: stloc.0  */
        loc0 = asm0.x60001bf(BLR.new_string("\\u"),{
                'boxed': arg0,
                'type': t0,
                'vtable': t0.prototype.vtable,
                'ifacemap': t0.prototype.ifacemap
    ...
    asm.CSStringConverter = BLR.declare_type("CSStringConverter",
        [],
        function () 
        {
            return new ((asm0)["System.Object"]())();
