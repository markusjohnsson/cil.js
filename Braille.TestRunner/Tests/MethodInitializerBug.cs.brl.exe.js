...
;
    ...
    asm.x6000011_ = function Main()
    {
        ...
        (asm1.x6000001)(((((asm0.x600000a)(newobj(t1,asm1.x600000e,[
            null
        ]).Value).vtable)["asm0.x60000aa"])())((asm0.x600000a)(newobj(t1,asm1.x600000e,[
            null
        ]).Value)));
        ...
        (asm1.x6000001)(((((asm0.x600000a)(newobj(t3,asm1.x600000e,[
            null
        ]).Value).vtable)["asm0.x60000aa"])())((asm0.x600000a)(newobj(t3,asm1.x600000e,[
            null
        ]).Value)));
        /* IL_32: ret */
        return ;
    ...
    (asm)["B`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            B_1.init = function ()
            {
                ...
                B_1.ArrayType = Array;
                B_1.MetadataName = "asm1.t2000008";
