...
;
    ...
    asm.x6000011_ = function Main()
    {
        ...
        (asm1.x6000001)(((((asm0.x600000a)(newobj(t1,asm1.x600000e,[
            null
        ]).Value).vtable)["asm0.x60000ac"])())((asm0.x600000a)(newobj(t1,asm1.x600000e,[
            null
        ]).Value)));
        ...
        (asm1.x6000001)(((((asm0.x600000a)(newobj(t3,asm1.x600000e,[
            null
        ]).Value).vtable)["asm0.x60000ac"])())((asm0.x600000a)(newobj(t3,asm1.x600000e,[
            null
        ]).Value)));
        /* IL_32: ret */
        return ;
    ...
    (asm)["A`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            A_1.init = function ()
            {
                ...
                initialized = true;
                initType(A_1,"A`1",asm,false,false,false,true,false,[],[],((asm0)["System.Object"])(),is_inst_default(A_1),Array,"asm1.t2000007");
                A_1.Value = null;
                A_1.Interfaces = [];
    ...
    (asm)["B`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            B_1.init = function ()
            {
                ...
                initialized = true;
                initType(B_1,"B`1",asm,false,false,false,true,false,[],[],((asm0)["System.Object"])(),is_inst_default(B_1),Array,"asm1.t2000008");
                B_1.Interfaces = [];
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                initialized = true;
                initType(D,"D",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(D),Array,"asm1.t200000a");
                D.Interfaces = [];
