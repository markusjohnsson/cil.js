    ...
    asm.x6000013_ = function Main(arg0)
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                /* IL_10: stloc.0 */
                loc0 = ((((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x6000037"])())((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)),(1|0));
                /* IL_11: ldloc.0 */
                /* IL_12: ldlen */
                /* IL_13: conv.i4 */
                ...
                (asm1.x6000001)({
                    'boxed': ((((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t2)).vtable)["asm0.x6000008"])())((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t2)),(asm0.x600000a)((loc0.jsarr)[loc1])),
                    'type': t3,
                ...
                (asm1.x6000001)(((((asm0.x600000a)((loc0.jsarr)[loc1]).vtable)["asm0.x60000a6"])())((asm0.x600000a)((loc0.jsarr)[loc1])));
                /* IL_55: ldloc.1 */
                /* IL_56: ldc.i4.1 */
                /* IL_57: add */
                /* IL_58: stloc.1 */
                ...
                /* IL_6F: stloc.2 */
                loc2 = ((((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t4)).vtable)["asm0.x6000037"])())((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t4)),(1|0));
                /* IL_70: ldloc.2 */
                /* IL_71: ldc.i4.0 */
                /* IL_72: ldelem.ref */
                /* IL_73: castclass A2*/
                ...
                /* IL_92: stloc.3 */
                loc3 = ((((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t6)).vtable)["asm0.x6000037"])())((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t6)),(1|0));
                /* IL_93: ldloc.3 */
                /* IL_94: ldlen */
                /* IL_95: conv.i4 */
    ...
    asm.A2 = (function ()
    {
        ...
        return function ()
        {
            ...
            A2.init = function ()
            {
                ...
                A2.BaseType = ((asm0)["System.Attribute"])();
                A2.FullName = "A2";
                A2.Assembly = asm;
                A2.Interfaces = [];
                A2.IsInst = function (t) { return t instanceof A2 ? t : null; };
                A2.IsValueType = false;
                A2.IsPrimitive = false;
                A2.IsInterface = false;
                A2.IsGenericTypeDefinition = false;
                A2.IsNullable = false;
                A2.ArrayType = Array;
