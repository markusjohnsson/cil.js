    ...
    asm.x6000011_ = function Main(arg0)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_10: stloc.0 */
                loc0 = (((asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)).vtable)["asm0.x600003a"])())(asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)),(1|0));
                /* IL_11: ldloc.0 */
                /* IL_12: ldlen */
                /* IL_13: conv.i4 */
                ...
                asm1.x6000001({
                        'boxed': (((asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t3)).vtable)["asm0.x6000008"])())(asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t3)),asm0.x600000a(BLR.ldelem_ref(loc0,loc1))),
                        'type': t4,
                ...
                asm1.x6000001((((asm0.x600000a(BLR.ldelem_ref(loc0,loc1)).vtable)["asm0.x60000d7"])())(asm0.x600000a(BLR.ldelem_ref(loc0,loc1))));
                /* IL_55: ldloc.1 */
                /* IL_56: ldc.i4.1 */
                /* IL_57: add */
                /* IL_58: stloc.1 */
                ...
                /* IL_6F: stloc.2 */
                loc2 = (((asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t5)).vtable)["asm0.x600003a"])())(asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t5)),(1|0));
                /* IL_70: ldloc.2 */
                /* IL_71: ldc.i4.0 */
                /* IL_72: ldelem.ref */
                /* IL_73: castclass A2*/
                ...
                asm1.x6000001(asm1.x600000c(BLR.cast_class(BLR.ldelem_ref(loc2,(0|0)),t6)));
                /* IL_82: ldtoken D*/
                /* IL_87: call Type GetTypeFromHandle(System.RuntimeTypeHandle)*/
                /* IL_8C: ldc.i4.1 */
                /* IL_8D: callvirt Object[] GetCustomAttributes(System.Boolean)*/
                /* IL_92: stloc.3 */
                loc3 = (((asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t7)).vtable)["asm0.x600003a"])())(asm0.x60000d8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t7)),(1|0));
                /* IL_93: ldloc.3 */
                /* IL_94: ldlen */
                /* IL_95: conv.i4 */
