    ...
    asm.A = (function ()
    {
        ...
        return function ()
        {
            ...
            A.init = function ()
            {
                ...
                initialized = true;
                initType(A,"A",asm,false,false,false,false,false,[],[],((asm0)["System.Exception"])(),is_inst_default(A),Array,"asm1.t2000007");
                A.Interfaces = [];
                declare_virtual(A,"asm0.x60000a2","asm0.x60000a2");
                declare_virtual(A,"asm0.x60000a3","asm0.x60000a3");
                declare_virtual(A,"asm0.x6000005","asm0.x60000a4");
    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                initType(B,"B",asm,false,false,false,false,false,[],[],((asm0)["System.Exception"])(),is_inst_default(B),Array,"asm1.t2000008");
                B.Interfaces = [];
                declare_virtual(B,"asm0.x60000a2","asm0.x60000a2");
                declare_virtual(B,"asm0.x60000a3","asm0.x60000a3");
                declare_virtual(B,"asm0.x6000005","asm0.x60000a4");
    ...
    asm.C = (function ()
    {
        ...
        return function ()
        {
            ...
            C.init = function ()
            {
                ...
                initialized = true;
                initType(C,"C",asm,false,false,false,false,false,[],[],(asm1.B)(),is_inst_default(C),Array,"asm1.t2000009");
                C.Interfaces = [];
                declare_virtual(C,"asm0.x60000a2","asm0.x60000a2");
                declare_virtual(C,"asm0.x60000a3","asm0.x60000a3");
                declare_virtual(C,"asm0.x6000005","asm0.x60000a4");
