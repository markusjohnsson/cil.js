var asm1;(function (asm) 
{
        ...
        return function _cctor() 
        {
            ...
            while (in_block_0){
                ...
                switch (__pos__){
                    ...
                    (t2)["CS$<>9__CachedAnonymousMethodDelegate1"] = BLR.newobj(t4,asm1.x6000012,[null,null,asm1.x6000018(T)]);
                    case 0x1A:
                    (asm1.x6000017(T))();
    ...
    asm.x600001a = BLR.delegate_invoke;;
    
    /*System.IAsyncResult Func.BeginInvoke(Object,AsyncCallback,Object)*/
    asm.x600001b = BLR.delegate_begin_invoke;;
    
    /*System.Boolean Func.EndInvoke(IAsyncResult)*/
    asm.x600001c = BLR.delegate_end_invoke;;
    
    /* Func..ctor(Object,IntPtr)*/
    asm.x6000019 = BLR.delegate_ctor;;
    ...
    asm.x600001e_ = function _cctor() 
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                (t0)["CS$<>9__CachedAnonymousMethodDelegate1"] = BLR.newobj(t1,asm1.x6000019,[null,null,asm1.x600001f]);
                case 0x1A:
                asm1.x600001e();
    ...
    (asm)["Func`2"] = BLR.declare_type("Func_2",
        ["T1","T2"],
        function (T1, T2) 
        {
            return {};
    ...
    asm.Func = BLR.declare_type("Func",
        [],
        function () 
        {
            return {};
