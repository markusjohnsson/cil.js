    ...
    asm.x600000c_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                (t1)["CS$<>9__CachedAnonymousMethodDelegate1"] = BLR.newobj(t2,asm0.x6000127,[null, null, asm1.x600000f]);
                case 0x18:
                ...
                asm1.x600000a(BLR.newobj(t2,asm0.x6000127,[null, null, asm1.x600000d]));
                asm0.x6000126();
                ...
                t1.MyEvent._methodPtr.apply(null,((t1.MyEvent._target) ? ([
                        ...
                        BLR.newobj(t4,asm0.x6000125,[null])
                    ]) : ([
                        BLR.newobj(t3,asm0.x600000c,[null]),
                        BLR.newobj(t4,asm0.x6000125,[null])
                    ])));
                ...
                asm1.x600000b(BLR.newobj(t2,asm0.x6000127,[null, null, asm1.x600000d]));
                asm0.x6000126();
