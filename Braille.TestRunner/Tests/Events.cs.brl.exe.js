...
;
    ...
    asm.x600000c_ = function add_MyEvent(arg0)
    {
        ...
        (t0)["MyEvent"] = cast_class((asm0.x600004e)(t0.MyEvent,arg0),t1);
        /* IL_15: ret */
        return ;
    };
    ...
    asm.x600000d_ = function remove_MyEvent(arg0)
    {
        ...
        /* IL_0B: castclass System.EventHandler*/
        /* IL_10: stsfld EventHandler MyEvent*/
        (t0)["MyEvent"] = cast_class((asm0.x600004f)(t0.MyEvent,arg0),t1);
        /* IL_15: ret */
        return ;
    };
    ...
    asm.x600000e_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                (t0)["CS$<>9__CachedAnonymousMethodDelegate1"] = newobj(t1,asm0.x60000f0,[ null,null,asm1.x6000011 ]);
                case 0x18:
                ...
                (asm1.x600000c)(newobj(t1,asm0.x60000f0,[ null,null,asm1.x600000f ]));
                ...
                (t0.MyEvent._methodPtr.apply)(null,((t0.MyEvent._target) ? ([ t0.MyEvent._target,newobj(t2,asm0.x600000c,[ null ]),newobj(t3,asm0.x60000ee,[ null ]) ]) : ([ newobj(t2,asm0.x600000c,[ null ]),newobj(t3,asm0.x60000ee,[ null ]) ])));
                /* IL_47: ldnull */
                ...
                (asm1.x600000d)(newobj(t1,asm0.x60000f0,[ null,null,asm1.x600000f ]));
