...
;
    ...
    asm.x600000c_ = function add_MyEvent(arg0)
    {
        ...
        st_02 = (asm0.x600003e)(st_00,st_01);
    ...
    asm.x600000d_ = function remove_MyEvent(arg0)
    {
        ...
        st_02 = (asm0.x600003f)(st_00,st_01);
        /* IL_0B: castclass System.EventHandler*/
        st_03 = cast_class(st_02,t1);
        /* IL_10: stsfld EventHandler MyEvent*/
        (t0)["MyEvent"] = st_03;
    ...
    asm.x600000e_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                st_03 = newobj(t1,asm0.x60000a3,[ null,st_01,st_02 ]);
