    ...
    (asm)["B`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            B_1.init = function ()
            {
                ...
                initialized = true;
                initType(B_1,"B`1",asm,false,false,false,true,false,[],[],((asm0)["System.Object"])(),is_inst_default(B_1),Array,"asm1.t2000009");
                B_1.Interfaces = [];
    ...
    asm.C = (function ()
    {
        ...
        return function ()
        {
            ...
            C.init = function ()
            {
                ...
                initialized = true;
                initType(C,"C",asm,false,false,false,false,false,[],[],((asm1)["B`1"])((asm1.C)()),is_inst_default(C),Array,"asm1.t200000a");
                C.Interfaces = [];
