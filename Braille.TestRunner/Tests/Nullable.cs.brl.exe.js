...
;
    ...
    asm.x600000c_ = function Main()
    {
        ...
        (asm1.x600000e)(clone_value(newobj(t1,asm0.x6000099,[ null,clone_value(loc0) ])));
        /* IL_38: ldloca.s 4*/
        st_09 = {
            'w': function ()
            {
        ...
        (asm1.x600000e)(clone_value(newobj(t1,asm0.x6000099,[ null,clone_value(loc4) ])));
        /* IL_4C: ldnull */
        st_0C = null;
