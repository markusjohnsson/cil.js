...
;
    ...
    asm.x600000c = function Main()
    {
        ...
        (asm1.x600000d)(new_string("hello world"));
        /* IL_0A: ldstr xyzw*/
        /* IL_0F: call Void Log(System.String)*/
        (asm1.x600000d)(new_string("xyzw"));
        /* IL_14: ldstr 1234*/
        /* IL_19: call Void Log(System.String)*/
        (asm1.x600000d)(new_string("1234"));
        /* IL_1E: ret */
        return ;
    };;
