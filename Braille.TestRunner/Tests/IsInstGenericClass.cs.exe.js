...
((asm1.x600000c)(asm1.A))(st_02);
/* IL_1E: ldnull */
st_03 = null;
/* IL_1F: call Void Test(System.Object)*/
((asm1.x600000c)(asm1.A))(st_03);
/* IL_24: ret */
return ; };
...
function D_1() { 
 if (!initialized){
initialized = true;D_1.IsValueType = false;D_1.prototype.vtable = { 
'x6000001': asm.x6000001 
};
} };
D_1.prototype = { 
