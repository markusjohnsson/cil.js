...
;
    ...
    asm.x600000d = function X(arg0,arg1)
    {
        ...
        /* IL_12: ret */
        return (asm0.x6000163)(arg0.AY,arg1);
    };;
    ...
    asm.x600000e_ = function Main()
    {
        ...
        /* IL_10: ldelem.ref */
        /* IL_11: stloc.0 */
        loc0 = (((((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x60000b7"])())((asm0.x60000a7)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0))).jsarr)[(0|0)];
        /* IL_12: ldloc.0 */
        st_0B = loc0;
        /* IL_13: ldstr Hello*/
        /* IL_18: newobj Void .ctor(System.String)*/
        st_0C = newobj(t0,asm1.x600000c,[
            null,
            new_string("Hello")
        ]);
        /* IL_1D: ldc.i4.1 */
        ...
        /* IL_23: stloc.1 */
        loc1 = new_array(t1,(1|0));
        /* IL_24: ldloc.1 */
        st_08 = loc1;
        /* IL_25: ldc.i4.0 */
        st_09 = (0|0);
        /* IL_26: ldstr World*/
        st_0A = new_string("World");
        /* IL_2B: stelem.ref */
        (st_08.jsarr)[st_09] = st_0A;
        /* IL_2C: ldloc.1 */
        st_0D = loc1;
        /* IL_2D: callvirt Object Invoke(System.Object, System.Object[])*/
        st_0E = (asm0.x6000043)(st_0B,st_0C,st_0D);
