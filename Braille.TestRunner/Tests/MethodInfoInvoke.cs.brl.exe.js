...
;
    ...
    asm.x600000d = function X(arg0,arg1)
    {
        ...
        /* IL_12: ret */
        return (asm0.x600016d)(arg0.AY,arg1);
    };;
    /* Void .ctor(System.String)*/
    ...
    asm.x600000e_ = function Main()
    {
        ...
        /* IL_10: ldelem.ref */
        /* IL_11: stloc.0 */
        loc0 = (((((asm0.x60000ab)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x60000bb"])())((asm0.x60000ab)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0))).jsarr)[(0|0)];
        /* IL_12: ldloc.0 */
        st_0B = loc0;
        /* IL_13: ldstr Hello*/
