    ...
    (asm)["Braille.TestRunner.Tests.TestTest"] = (function ()
    {
        ...
        return function ()
        {
            ...
            TestTest.init = function ()
            {
                ...
                initialized = true;
                initType(TestTest,"Braille.TestRunner.Tests.TestTest",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(TestTest),Array,"asm1.t2000007");
                TestTest.Interfaces = [];
                declare_virtual(TestTest,"asm0.x6000005","asm0.x6000005");
                declare_virtual(TestTest,"asm0.x6000008","asm0.x6000008");
                declare_virtual(TestTest,"asm0.x6000009","asm0.x6000009");
            };
