                ...
                try {
                    ...
                    while (__pos_1__ >= 0){
                        ...
                        switch (__pos_1__){
                            ...
                            (((loc3.ifacemap)[t2].x600008d)())(convert_box_to_pointer_as_needed(loc3));
                            case 0x3B:
                            /* IL_3B: endfinally */
                            __pos_1__ = -1;
                            break;
    ...
    asm.Iter = (function ()
    {
        ...
        return function ()
        {
            ...
            Iter.init = function ()
            {
                ...
                Iter.MetadataName = "asm1.t2000008";
                Iter.GenericArguments = {};
                (Iter.GenericArguments)["asm1.t2000008"] = [];
                (Iter.GenericArguments)["asm0.t2000002"] = [];
