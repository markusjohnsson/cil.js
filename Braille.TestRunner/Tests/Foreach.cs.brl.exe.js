    ...
    asm.Iter = (function ()
    {
        ...
        return function ()
        {
            ...
            Iter.init = function ()
            {
                ...
                Iter.BaseType = ((asm0)["System.Object"])();
                Iter.FullName = "Iter";
                Iter.Assembly = asm;
                Iter.Interfaces = [];
                Iter.IsInst = function (t) { return t instanceof Iter ? t : null; };
                Iter.IsValueType = false;
                Iter.IsPrimitive = false;
                Iter.IsInterface = false;
                Iter.IsGenericTypeDefinition = false;
