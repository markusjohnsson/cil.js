    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                initType(B,"B",asm,true,false,false,false,false,[],[],((asm0)["System.ValueType"])(),is_inst_default(B),Array,"asm1.t2000008");
                B.Interfaces = [];
                declare_virtual(B,"asm0.x6000008","asm0.x6000016");
    ...
    (asm)["C`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            C_1.init = function ()
            {
                ...
                initialized = true;
                initType(C_1,"C`1",asm,false,false,false,true,false,[],[],((asm0)["System.Object"])(),is_inst_default(C_1),Array,"asm1.t2000009");
