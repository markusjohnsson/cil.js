...
;
    ...
    asm.x6000017_ = function Main()
    {
        ...
        ((asm1.x6000018)(((asm0)["System.Int32"])()))(newobj(t0,asm1.x6000012,[ null ]),(12345|0));
        /* IL_0F: newobj Void .ctor()*/
        /* IL_14: ldstr Hello*/
        /* IL_19: call Void Run[System.String](I`1[System.String], System.String)*/
        ((asm1.x6000018)(((asm0)["System.String"])()))(newobj(t3,asm1.x6000016,[ null ]),new_string("Hello"));
        /* IL_1E: ret */
        return ;
    };
    ...
    (asm)["I`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            I_1.init = function ()
            {
                ...
                I_1.Assembly = asm;
                I_1.Interfaces = [  ];
                I_1.IsInst = function (t) { return t.constructor.Interfaces.indexOf(I_1) != -1 ? t : null; };
