...
;
    ...
    asm.x6000018_ = function (T)
    {
        return function Run(arg0,arg1)
        {
            ...
            (((arg0.ifacemap)[t1].x600000c)())(arg0);
            /* IL_06: ldarg.0 */
            /* IL_07: ldarg.1 */
            /* IL_08: callvirt Void GenericArg(T)*/
            (((arg0.ifacemap)[t1].x600000d)())(arg0,arg1);
            /* IL_0D: ldarg.0 */
            /* IL_0E: callvirt T GenericReturn()*/
            /* IL_13: box T*/
            /* IL_18: call Void Log(System.Object)*/
            (asm1.x6000001)(box((((arg0.ifacemap)[t1].x600000e)())(arg0),t0));
            /* IL_1D: ret */
            return ;
        };
    };
    ...
    asm.A = (function ()
    {
        ...
        return function ()
        {
            ...
            A.init = function ()
            {
                ...
                (A.prototype.ifacemap)[((asm1)["I`1"])(((asm0)["System.Int32"])())] = {
                    'x600000c': function ()
                    {
                        return asm1.x600000f;
                    },
    ...
    (asm)["B`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            B_1.init = function ()
            {
                ...
                (B_1.prototype.ifacemap)[((asm1)["I`1"])(T)] = {
                    'x600000c': function ()
                    {
                        return asm1.x6000013;
                    },
