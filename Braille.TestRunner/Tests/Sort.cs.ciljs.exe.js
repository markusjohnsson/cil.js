var asm1; (function (asm)
{
    ...
    asm.x600000e_ = function Equals(arg0,arg1)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_2B: ret */
                return asm0.x60001c6(asm1.x600000a(loc0),asm1.x600000a(arg0));
                case 0x2C:
                /* IL_2C: ldc.i4.0 */
                /* IL_2D: ret */
                return (0|0);
    ...
    asm.x6000014_ = function CreateBazCollection()
    {
        ...
        /* IL_15: stelem.ref */
        CILJS.stelem_ref(loc0,(0|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("jb"), (25|0)]));
        /* IL_16: ldloc.0 */
        /* IL_17: ldc.i4.1 */
        /* IL_18: ldstr ana*/
        /* IL_1D: ldc.i4.s 20*/
        ...
        /* IL_24: stelem.ref */
        CILJS.stelem_ref(loc0,(1|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("ana"), (20|0)]));
        /* IL_25: ldloc.0 */
        /* IL_26: ldc.i4.2 */
        /* IL_27: ldstr reg*/
        /* IL_2C: ldc.i4.s 28*/
        ...
        /* IL_33: stelem.ref */
        CILJS.stelem_ref(loc0,(2|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("reg"), (28|0)]));
        /* IL_34: ldloc.0 */
        /* IL_35: ldc.i4.3 */
        /* IL_36: ldstr ro*/
        /* IL_3B: ldc.i4.s 25*/
        ...
        /* IL_42: stelem.ref */
        CILJS.stelem_ref(loc0,(3|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("ro"), (25|0)]));
        /* IL_43: ldloc.0 */
        /* IL_44: ldc.i4.4 */
        /* IL_45: ldstr jb*/
        /* IL_4A: ldc.i4.7 */
        ...
        /* IL_50: stelem.ref */
        CILJS.stelem_ref(loc0,(4|0),CILJS.newobj(t0,asm1.x600000c,[null, CILJS.new_string("jb"), (7|0)]));
        /* IL_51: ldloc.0 */
        /* IL_52: ret */
        return loc0;
    };
