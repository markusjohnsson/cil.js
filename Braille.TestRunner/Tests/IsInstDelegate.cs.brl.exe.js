var asm1; (function (asm)
{
    ...
    asm.x6000010_ = function Main(arg0)
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                (t1)["CS$<>9__CachedAnonymousMethodDelegate1"] = (BLR.newobj)(t3,asm1.x600000c,[
                    null,
                    null,
                    asm1.x6000015
                ]);
                ...
                (asm1.x6000014)((BLR.newobj)(t3,asm1.x600000c,[
                    null,
                    null,
                    asm1.x6000011
                ]));
                ...
                (asm1.x6000014)((BLR.newobj)(t5,asm1.x600000c,[
                    null,
                    null,
                    asm1.x6000012
                ]));
                ...
                (asm1.x6000014)((BLR.newobj)(t7,asm1.x600000c,[
                    null,
                    null,
                    asm1.x6000013
                ]));
    ...
    (asm)["FuncX`2"] = (BLR.declare_type)("FuncX_2",function (T,TResult)
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"FuncX`2",asm,false,false,false,true,false,[],[
            [
                asm1,
                "x600000d",
                "Invoke"
    ...
    (asm)["FuncX`1"] = (BLR.declare_type)("FuncX_1",function (T)
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"FuncX`1",asm,false,false,false,true,false,[],[
            [
                asm1,
                "x600000f",
                "Invoke"
