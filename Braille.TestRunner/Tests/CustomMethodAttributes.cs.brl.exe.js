...
;
    ...
    asm.x6000014_ = function Main()
    {
        ...
        /* IL_0F: stloc.0 */
        loc0 = ((((asm0.x60000a2)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x60000b2"])())((asm0.x60000a2)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)));
        /* IL_10: ldloc.0 */
        /* IL_11: ldc.i4.0 */
        /* IL_12: ldelem.ref */
        /* IL_13: ldc.i4.1 */
        ...
        (asm1.x6000001)(((((asm1.x600000d)(cast_class((loc2.jsarr)[(0|0)],t2)).vtable)["asm0.x6000038"])())((asm1.x600000d)(cast_class((loc2.jsarr)[(0|0)],t2))));
        /* IL_67: ret */
        return ;
    };
