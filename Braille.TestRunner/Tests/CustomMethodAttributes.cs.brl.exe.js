var asm1; (function (asm)
{
    ...
    asm.x6000014_ = function Main()
    {
        ...
        /* IL_19: stloc.1 */
        loc1 = (((BLR.ldelem_ref(loc0,(0|0)).vtable)["asm0.x600003c"])())(BLR.ldelem_ref(loc0,(0|0)),(1|0));
        /* IL_1A: ldloc.0 */
        /* IL_1B: ldc.i4.1 */
        /* IL_1C: ldelem.ref */
        /* IL_1D: ldc.i4.1 */
        ...
        /* IL_23: stloc.2 */
        loc2 = (((BLR.ldelem_ref(loc0,(1|0)).vtable)["asm0.x600003c"])())(BLR.ldelem_ref(loc0,(1|0)),(1|0));
        /* IL_24: ldloc.1 */
        /* IL_25: ldlen */
        /* IL_26: conv.i4 */
        ...
        asm1.x6000001((((asm0.x600000a(BLR.ldelem_ref(loc1,(0|0))).vtable)["asm0.x6000040"])())(asm0.x600000a(BLR.ldelem_ref(loc1,(0|0)))));
        /* IL_43: ldloc.2 */
        /* IL_44: ldlen */
        /* IL_45: conv.i4 */
        ...
        asm1.x6000001((((asm1.x600000d(BLR.cast_class(BLR.ldelem_ref(loc2,(0|0)),t3)).vtable)["asm0.x6000040"])())(asm1.x600000d(BLR.cast_class(BLR.ldelem_ref(loc2,(0|0)),t3))));
        /* IL_67: ret */
        return ;
    };
    /* Void .ctor()*/
