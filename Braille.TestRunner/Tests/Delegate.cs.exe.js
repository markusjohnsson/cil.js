...
asm.x600000b = function X() { var __braille_args__;
var st_00;
 __braille_args__ = arguments;
/* IL_00: ldstr RESULT!*/
st_00 = "RESULT!";
...
st_02 = (function () { var result;
 result = new (asm1.Foo)();
(asm1.x6000009)(result,st_00,cloneValue(st_01));
return result; })();
/* IL_0C: stloc.0 */
loc0 = st_02;
/* IL_0D: ldloc.0 */
...
/* IL_13: ret */
return ; };
asm.x600000d = function CallDelegate() { var __braille_args__;
var st_00;
var st_01;
var st_02;
 __braille_args__ = arguments;
...
function Foo() { 
 if (!initialized){
initialized = true;Foo.IsValueType = false;Foo.prototype.vtable = { 
