var asm1; (function (asm)
{
    ...
    asm.x600000e_ = function ObjectArray()
    {
        var t0;
        var t1;
        var __pos__;
        ...
        asm0.x6000157(loc0,BLR.new_string("test"),(0|0));
        /* IL_28: ldloc.0 */
        /* IL_29: ldc.i4.0 */
        /* IL_2A: ldelem.ref */
    ...
    asm.x600000f_ = function ValueTypeArray()
    {
        ...
        asm0.x6000157(st_0D,st_0E,st_0F);
        /* IL_3A: ldloc.0 */
        /* IL_3B: ldc.i4.0 */
        /* IL_3C: ldelem.ref */
        /* IL_3D: unbox.any A*/
    ...
    asm.x6000010_ = function InterfaceArray()
    {
        ...
        asm0.x6000157(st_06,st_07,st_08);
        /* IL_25: ldloc.0 */
        /* IL_26: ldc.i4.0 */
        /* IL_27: ldelem.ref */
        ...
        asm0.x6000157(st_10,st_11,st_12);
        /* IL_4B: ldloc.0 */
        /* IL_4C: ldc.i4.0 */
        /* IL_4D: ldelem.ref */
