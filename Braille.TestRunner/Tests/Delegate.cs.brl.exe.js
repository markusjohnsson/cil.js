...
;
    ...
    asm.x6000010_ = function Main()
    {
        ...
        /* IL_0C: stloc.0 */
        loc0 = newobj(t0,asm1.x600000c,[ null,null,asm1.x600000e ]);
        /* IL_0D: ldloc.0 */
        ...
        (asm1.x6000012)(loc0,newobj(t0,asm1.x600000c,[ null,null,asm1.x600000e ]));
        /* IL_40: ldstr f, Y*/
        ...
        (asm1.x6000012)(loc0,newobj(t0,asm1.x600000c,[ null,null,asm1.x600000f ]));
        /* IL_5C: ldstr f, null*/
    ...
    asm.x6000011 = function CallDelegate(arg0)
    {
        ...
        (asm1.x6000001)((arg0._methodPtr.apply)(null,((arg0._target) ? ([ arg0._target,(123|0) ]) : ([ (123|0) ]))));
        /* IL_0D: ret */
        return ;
    };;
