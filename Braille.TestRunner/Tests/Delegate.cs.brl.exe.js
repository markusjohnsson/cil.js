    ...
    asm.Foo = (function ()
    {
        ...
        return function ()
        {
            ...
            Foo.init = function ()
            {
                ...
                Foo.ArrayType = Array;
                Foo.MetadataName = "asm1.t2000007";
                Foo.GenericArguments = {};
                (Foo.GenericArguments)["asm1.t2000007"] = [];
                (Foo.GenericArguments)["asm0.t2000028"] = [];
                (Foo.GenericArguments)["asm0.t2000027"] = [];
                (Foo.GenericArguments)["asm0.t2000002"] = [];
