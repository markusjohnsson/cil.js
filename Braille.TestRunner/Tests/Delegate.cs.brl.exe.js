    ...
    asm.Foo = (function ()
    {
        ...
        return function ()
        {
            ...
            Foo.init = function ()
            {
                ...
                Foo.BaseType = ((asm0)["System.MulticastDelegate"])();
                Foo.FullName = "Foo";
                Foo.Assembly = asm;
                Foo.Interfaces = [];
                Foo.IsInst = function (t) { return t instanceof Foo ? t : null; };
                Foo.IsValueType = false;
                Foo.IsPrimitive = false;
                Foo.IsInterface = false;
                Foo.IsGenericTypeDefinition = false;
                Foo.IsNullable = false;
                Foo.ArrayType = Array;
