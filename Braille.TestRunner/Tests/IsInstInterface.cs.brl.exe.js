var asm1; (function (asm)
{
    ...
    asm.x6000010_ = function Main()
    {
        ...
        (asm1.x6000011)((BLR.newobj)(t1,asm1.x600000c,[
            null
        ]));
        /* IL_0A: newobj Void .ctor()*/
        /* IL_0F: call Void TestImpl(System.Object)*/
        (asm1.x6000011)((BLR.newobj)(t2,asm1.x600000d,[
            null
        ]));
        /* IL_14: newobj Void .ctor()*/
        /* IL_19: call Void TestImpl(System.Object)*/
        (asm1.x6000011)((BLR.newobj)(t3,asm1.x600000e,[
            null
        ]));
        /* IL_1E: newobj Void .ctor()*/
        /* IL_23: call Void TestImpl(System.Object)*/
        (asm1.x6000011)((BLR.newobj)(t4,asm1.x600000f,[
            null
        ]));
        /* IL_28: ret */
        return ;
    ...
    asm.I1 = (BLR.declare_type)("I1",function ()
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"I1",asm,false,false,true,false,false,[],[],null,(BLR.is_inst_interface)(this),Array,"asm1.t2000007");
        this.Interfaces = [];
    },function ()
    {
        return {};
    },[]);
    asm.I2 = (BLR.declare_type)("I2",function ()
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"I2",asm,false,false,true,false,false,[],[],null,(BLR.is_inst_interface)(this),Array,"asm1.t2000008");
        this.Interfaces = [];
    },function ()
    {
        return {};
    },[]);
    asm.I3 = (BLR.declare_type)("I3",function ()
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"I3",asm,false,false,true,false,false,[],[],null,(BLR.is_inst_interface)(this),Array,"asm1.t2000009");
        this.Interfaces = [
            (asm1.I2)()
        ];
    },function ()
    ...
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"A",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),(BLR.is_inst_default)(this),Array,"asm1.t200000a");
        this.Interfaces = [];
        (BLR.declare_virtual)(this,"asm0.x6000005","asm0.x6000005");
        (BLR.declare_virtual)(this,"asm0.x6000008","asm0.x6000008");
        (BLR.declare_virtual)(this,"asm0.x6000009","asm0.x6000009");
    ...
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"B",asm,false,false,false,false,false,[],[],(asm1.A)(),(BLR.is_inst_default)(this),Array,"asm1.t200000b");
        this.Interfaces = [
            (asm1.I1)(),
            (asm1.I2)()
        ];
    ...
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"C",asm,false,false,false,false,false,[],[],(asm1.A)(),(BLR.is_inst_default)(this),Array,"asm1.t200000c");
        this.Interfaces = [
            (asm1.I3)(),
            (asm1.I2)()
        ];
    ...
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"D",asm,false,false,false,false,false,[],[],(asm1.C)(),(BLR.is_inst_default)(this),Array,"asm1.t200000d");
        this.Interfaces = [
            (asm1.I2)(),
            (asm1.I3)()
        ];
    ...
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"Program",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),(BLR.is_inst_default)(this),Array,"asm1.t200000e");
        this.Interfaces = [];
        (BLR.declare_virtual)(this,"asm0.x6000005","asm0.x6000005");
        (BLR.declare_virtual)(this,"asm0.x6000008","asm0.x6000008");
        (BLR.declare_virtual)(this,"asm0.x6000009","asm0.x6000009");
