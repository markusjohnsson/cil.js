var asm1; (function (asm)
{
    ...
    asm.x600000e = function ObjectArray()
    {
        ...
        asm0.x6000191(loc0,CILJS.new_string("test"),(0|0));
        /* IL_28: ldloc.0 */
        /* IL_29: ldc.i4.0 */
        /* IL_2A: ldelem.ref */
    ...
    asm.x6000010_ = function InterfaceArray()
    {
        ...
        asm1.x6000001((((CILJS.ldelem_ref(loc0,(0|0)).ifacemap)[t0].x600000a)())(CILJS.convert_box_to_pointer_as_needed(CILJS.ldelem_ref(loc0,(0|0)))));
        /* IL_32: ldloc.0 */
        st_10 = loc0;
        /* IL_33: newobj Void .ctor()*/
        /* IL_38: stloc.2 */
        loc2 = CILJS.newobj(t2,asm1.x600000d,[null]);
        /* IL_39: ldloc.2 */
        st_0E = loc2;
        /* IL_3A: ldstr hello*/
    ...
    asm.A = CILJS.declare_type(
        ...
        function ()
        {
            ...
            CILJS.init_type(this,asm,"A",true,false,false,false,false,[],[
                ...
                ],(asm0)["System.ValueType"](),CILJS.is_inst_value_type(this),Array,"asm1.t2000007");
