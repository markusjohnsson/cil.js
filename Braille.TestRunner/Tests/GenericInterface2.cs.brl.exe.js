    ...
    asm.A = (function ()
    {
        ...
        return function ()
        {
            ...
            A.init = function ()
            {
                ...
                initialized = true;
                initType(A,"A",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(A),Array,"asm1.t2000008");
                A.Interfaces = [];
    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                initType(B,"B",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(B),Array,"asm1.t2000009");
                B.Interfaces = [];
    ...
    asm.C = (function ()
    {
        ...
        return function ()
        {
            ...
            C.init = function ()
            {
                ...
                initialized = true;
                initType(C,"C",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(C),Array,"asm1.t200000a");
                C.Interfaces = [
                    ((asm1)["I`1"])((asm1.A)()),
                    ((asm1)["I`1"])((asm1.B)())
                ];
                declare_virtual(C,"asm1.x600000f","asm1.x600000f");
                declare_virtual(C,"asm1.x6000010","asm1.x6000010");
