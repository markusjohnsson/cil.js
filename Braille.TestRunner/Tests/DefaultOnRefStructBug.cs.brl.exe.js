...
;
    ...
    asm.x6000001 = function (a, b) { return Number(a === b); /* && a && !a.constructor.IsValueType;*/ };;
        ...
        return function Copy(arg0,arg1,arg2,arg3,arg4)
        {
            ...
            while (__pos_0__ >= 0){
                ...
                switch (__pos_0__){
                    ...
                    /* IL_16: throw */
                    throw (asm0.x600012c)(new_string("System.ArgumentNullException"));
                    case 0x17:
                    /* IL_17: ldarg.2 */
                    /* IL_18: ldnull */
                    /* IL_1A: ceq */
                    ...
                    /* IL_73: throw */
                    throw (asm0.x600012c)(new_string("System.ArgumentException"));
                    case 0x74:
                    /* IL_74: ldarg.3 */
                    /* IL_75: ldarg.2 */
                    /* IL_76: ldlen */
        ...
        return function LastIndexOf(arg0,arg1,arg2,arg3)
        {
            ...
            while (__pos_0__ >= 0){
                ...
                switch (__pos_0__){
                    ...
                    if (arg2 < (asm0.x600013d)(arg0,(0|0))){
                        __pos_0__ = 0x40;
                        continue;
                    }
                    /* IL_25: ldarg.2 */
                    ...
                    /* IL_3B: ldc.i4.0 */
                    /* IL_3D: ceq */
                    st_1E = ((((((((arg2 - arg3) | (0|0)) + (1|0)) | (0|0)) < (asm0.x600013d)(arg0,(0|0))) ? (1) : (0)) === (0|0)) ? (1) : (0));
                    /* IL_3E: br.s IL_41*/
                    __pos_0__ = 0x41;
                    continue;
                    case 0x40:
                    ...
                    /* IL_60: stloc.0 */
                    loc0 = asm1.GetDefaultEqualityComparer((asm0.x60000ab)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).ctor)();
                    /* IL_61: ldarg.2 */
                    /* IL_62: stloc.1 */
                    loc1 = arg2;
                    /* IL_63: br.s IL_8E*/
                    ...
                    /* IL_80: ceq */
                    /* IL_81: stloc.3 */
                    loc3 = (((((loc0.ifacemap)[t1].x600002e)())(convert_box_to_pointer_as_needed(loc0),box((arg0.jsarr)[loc1],t0),box(arg1,t0)) === (0|0)) ? (1) : (0));
                    /* IL_82: ldloc.3 */
    ...
    asm.x60001a0 = function (arg0,arg1,arg2)
    {
        (asm.x60001a0_init.apply)(this,arguments);
        return (asm.x60001a0_.apply)(this,arguments);
    };;
    asm.x60001a0_ = function _Sort_b__0(arg0,arg1,arg2)
    {
        var t0;
        var t1;
        var loc0;
    ...
    (asm)["A`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            A_1.init = function ()
            {
                ...
                A_1.BaseType = ((asm0)["System.ValueType"])();
                A_1.FullName = "A`1";
                A_1.Assembly = asm;
                A_1.Interfaces = [];
                A_1.IsInst = function (t) { return t instanceof A_1 ? t : null; };
                A_1.IsValueType = true;
                ...
                (A_1.GenericArguments)["asm0.t2000006"] = [];
