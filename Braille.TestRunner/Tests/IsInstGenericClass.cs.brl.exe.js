    ...
    (asm)["D`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            D_1.init = function ()
            {
                ...
                initialized = true;
                initType(D_1,"D`1",asm,false,false,false,true,false,[],[],((asm0)["System.Object"])(),is_inst_default(D_1),Array,"asm1.t200000a");
                D_1.Interfaces = [];
                (D_1.GenericArguments)["asm1.t200000a"] = [
                    T
                ];
                declare_virtual(D_1,"asm0.x6000005","asm0.x6000005");
                declare_virtual(D_1,"asm0.x6000008","asm0.x6000008");
                declare_virtual(D_1,"asm0.x6000009","asm0.x6000009");
            };
