...
;
    ...
    asm.x6000011_ = function Main()
    {
        ...
        ((asm1.x600000f)((asm1.A)()))(newobj(t0,asm1.x600000c,[
            null
        ]));
        /* IL_0A: newobj Void .ctor()*/
        /* IL_0F: call Void Test(System.Object)*/
        ((asm1.x600000f)((asm1.A)()))(newobj(t1,asm1.x600000d,[
            null
        ]));
        /* IL_14: newobj Void .ctor()*/
        /* IL_19: call Void Test(System.Object)*/
        ((asm1.x600000f)((asm1.A)()))(newobj(t2,asm1.x600000e,[
            null
        ]));
        /* IL_1E: ldnull */
    ...
    (asm)["D`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            D_1.init = function ()
            {
                ...
                initialized = true;
                D_1.CustomAttributes = [];
                D_1.Methods = [];
                D_1.BaseType = ((asm0)["System.Object"])();
                D_1.FullName = "D`1";
                D_1.Assembly = asm;
                D_1.Interfaces = [];
                D_1.IsInst = function (t) { return t instanceof D_1 ? t : null; };
                D_1.IsValueType = false;
                D_1.IsPrimitive = false;
                D_1.IsInterface = false;
                D_1.IsGenericTypeDefinition = true;
                D_1.IsNullable = false;
                D_1.ArrayType = Array;
                D_1.GenericArguments = [
                    T
                ];
