    ...
    (asm)["C`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            C_1.init = function ()
            {
                ...
                initialized = true;
                initType(C_1,"C`1",asm,false,false,false,true,false,[],[],(asm1.C)(),is_inst_default(C_1),Array,"asm1.t200000a");
                C_1.Interfaces = [];
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                initialized = true;
                initType(D,"D",asm,false,false,false,false,false,[],[],((asm1)["C`1"])((asm1.A)()),is_inst_default(D),Array,"asm1.t200000b");
                D.Interfaces = [];
    ...
    asm.E = (function ()
    {
        ...
        return function ()
        {
            ...
            E.init = function ()
            {
                ...
                initialized = true;
                initType(E,"E",asm,false,false,false,false,false,[],[],((asm1)["C`1"])((asm1.B)()),is_inst_default(E),Array,"asm1.t200000c");
                E.Interfaces = [];
