    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                initType(B,"B",asm,false,false,false,false,false,[],[],(asm1.A)(),is_inst_default(B),Array,"asm1.t2000009");
                B.Interfaces = [
                    (asm1.I)()
                ];
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                initialized = true;
                initType(D,"D",asm,false,false,false,false,false,[],[],(asm1.B)(),is_inst_default(D),Array,"asm1.t200000b");
                D.Interfaces = [
                    (asm1.I)()
                ];
