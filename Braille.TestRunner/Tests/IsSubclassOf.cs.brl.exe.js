var asm1; (function (asm)
{
    ...
    asm.x6000010_ = function Main()
    {
        ...
        (asm1.x6000011)((BLR.new_array)(t0,(0|0)));
        /* IL_0B: ret */
        return ;
    };
    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                (BLR.init_type)(B,"B",asm,false,false,false,false,false,[],[],(asm1.A)(),(BLR.is_inst_default)(B),Array,"asm1.t2000009");
                B.Interfaces = [
                    (asm1.I)()
                ];
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                initialized = true;
                (BLR.init_type)(D,"D",asm,false,false,false,false,false,[],[],(asm1.B)(),(BLR.is_inst_default)(D),Array,"asm1.t200000b");
                D.Interfaces = [
                    (asm1.I)()
                ];
