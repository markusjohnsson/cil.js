...
/* IL_0B: ret */
return st_02; };
asm.x600001b = function(o) { return o.jsarr.length; };
asm.x600001c = function(o, i) { return box(o.jsarr[i], o.type); };
...
st_02 = (asm0.x600001c)(st_00,st_01);
/* IL_08: stloc.0 */
loc0 = st_02;
/* IL_0B: ldloc.0 */
st_03 = loc0;
...
/* IL_06: ret */
return ; };
asm.x6000045 = function(o) { return o.jsstr.length; };
asm.x6000046 = function(a, b) { return a.jsstr === b.jsstr; };
asm.x6000047 = function () { return new_string(String.prototype.concat.apply('', arguments)); };
...
st_02 = (asm0.x6000046)(st_00,st_01);
/* IL_08: ldc.i4.0 */
st_03 = 0;
/* IL_0A: ceq */
st_04 = (st_02 === st_03) ? (1) : (0);
...
/* IL_11: ret */
return st_04; };
asm.x600005e = function(o) { return new_string(String.fromCharCode(o.boxed)); };
...
/* IL_11: ret */
return st_04; };
asm.x600006c = function(o) { return new_string(o.boxed.toString()); };
...
st_04 = (asm0.x6000074)(st_02,st_03);
/* IL_12: stloc.0 */
loc0 = st_04;
/* IL_15: ldloc.0 */
st_05 = loc0;
/* IL_16: ret */
return st_05; };
asm.x6000072 = function(o) { return Math.sqrt(o.boxed); };
asm.x6000073 = function(o) { return Math.floor(o.boxed); };
asm.x6000074 = function(a, b) { return Math.pow(a.boxed, b.boxed); };
...
st_01 = ((st_00)[((asm0)["System.Collections.Generic.IEnumerable`1"])(T)].x6000021)(st_00);
/* IL_06: stloc.2 */
loc2 = st_01;
try {
...
st_03 = ((st_02)[((asm0)["System.Collections.Generic.IEnumerator`1"])(T)].x600002a)(st_02);
/* IL_0F: stloc.0 */
loc0 = st_03;
/* IL_10: ldloc.0 */
st_04 = loc0;
...
st_06 = ((st_05)[((asm0)["System.Collections.Generic.IEnumerator`1"])(T)].x600002b)(st_05);
...
st_23 = (function () { var result;
 result = new ((arguments)[0])();
(asm0.x6000082)(result,st_21,st_22);
return result; })(t3);
...
st_08 = ((st_06)[((asm0)["System.Collections.Generic.IEnumerable`1"])(((arguments)[0].constructor.GenericArguments)[0])].x6000021)(st_06);
...
st_0E = ((st_0C)[((asm0)["System.Collections.Generic.IEnumerator`1"])(((arguments)[0].constructor.GenericArguments)[0])].x600002a)(st_0C);
...
st_1C = ((st_1B)[((asm0)["System.Collections.Generic.IEnumerator`1"])(((arguments)[0].constructor.GenericArguments)[0])].x600002b)(st_1B);
...
((st_05)[((asm0)["System.IDisposable"])()].x6000026)(st_05);
case 0x1A:
/* IL_1A: ret */
return ;
}
...
st_1E = ((st_1D)[((asm0)["System.Collections.Generic.IEnumerator`1"])(((arguments)[0].constructor.GenericArguments)[0])].x600002b)(st_1D);
