var asm1; (function (asm)
{
    ...
    asm.x600000e_ = function Equals(arg0,arg1)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                /* IL_2B: ret */
                return asm0.x60001b7(asm1.x600000a(loc0),asm1.x600000a(arg0));
                case 0x2C:
                /* IL_2C: ldc.i4.0 */
                /* IL_2D: ret */
                return (0|0);
    ...
    asm.x6000010 = function Compare(arg0,arg1,arg2)
    {
        ...
        /* IL_11: stloc.0 */
        loc0 = (((asm1.x600000a(arg1).vtable)["asm0.x60001c4"])())(asm1.x600000a(arg1),asm1.x600000a(arg2));
        /* IL_12: ldloc.0 */
        /* IL_13: neg */
        /* IL_14: ret */
        return (-(loc0));
    ...
    asm.x6000015_ = function Main()
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                (asm0.x600016f(asm1.Baz()))(loc0,BLR.newobj(t1,asm1.x6000013,[null]));
                /* IL_1B: ldc.i4.0 */
                /* IL_1C: stloc.1 */
                loc1 = (0|0);
                /* IL_1D: br.s IL_2B*/
                ...
                (asm0.x600016f(asm1.Baz()))(loc2,BLR.newobj(t3,asm1.x6000011,[null]));
                /* IL_4C: ldc.i4.0 */
                /* IL_4D: stloc.3 */
                loc3 = (0|0);
                /* IL_4E: br.s IL_5C*/
