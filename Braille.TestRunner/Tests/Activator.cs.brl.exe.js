var asm1; (function (asm)
{
    ...
    asm.x600000c_ = function Main()
    {
        ...
        /* IL_0F: castclass A*/
        /* IL_14: stloc.0 */
        loc0 = BLR.cast_class(asm0.x6000053(asm0.x60000b8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t1))),t1);
        /* IL_15: ldtoken A*/
        ...
        asm1.x6000001({
                'boxed': (((asm0.x60000b8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)).vtable)["asm0.x6000008"])())(asm0.x60000b8(BLR.new_handle((asm0)["System.RuntimeTypeHandle"](),t1)),asm0.x600000a(loc0)),
                'type': t2,
