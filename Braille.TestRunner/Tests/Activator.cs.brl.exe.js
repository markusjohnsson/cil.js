...
;
    ...
    asm.x600000e_ = function Main()
    {
        ...
        (asm1.x6000001)({
            'boxed': ((((asm0.x60000a0)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x6000009"])())((asm0.x60000a0)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)),(asm0.x600000a)(loc0)),
            'type': t1,
