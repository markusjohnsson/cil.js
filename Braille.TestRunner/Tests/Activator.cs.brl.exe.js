...
;
    ...
    asm.x600000e_ = function Main()
    {
        ...
        /* IL_0F: castclass A*/
        /* IL_14: stloc.0 */
        loc0 = cast_class((asm0.x600004b)((asm0.x60000a0)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0))),t0);
        /* IL_15: ldtoken A*/
        ...
        (asm1.x6000001)({
            'boxed': ((((asm0.x60000a0)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)).vtable)["asm0.x6000008"])())((asm0.x60000a0)(new_handle(((asm0)["System.RuntimeTypeHandle"])(),t0)),(asm0.x600000a)(loc0)),
            'type': t1,
