var asm1; (function (asm)
{
    ...
    asm.x600000c_ = function GetIntArray()
    {
        ...
        st_03 = BLR.new_handle((asm0)["System.RuntimeFieldHandle"](),{
                'type': (asm1)["<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}"](),
    ...
    (asm)["<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}"] = BLR.declare_type(
        "_PrivateImplementationDetails__7B624A4C_AE15_4077_A816_E725CFF01DB8_",
        [],
        function ()
        {
            return new ((asm0)["System.Object"]())();
        ...
        {
            this.init = BLR.nop;
            BLR.init_type(this,asm,"<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}",false,false,false,false,false,[],[],(asm0)["System.Object"](),BLR.is_inst_default(this),Array,"asm1.t2000008");
    ...
    (asm)["<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}+__StaticArrayInitTypeSize=36"] = BLR.declare_type(
        ...
        {
            this.init = BLR.nop;
            BLR.init_type(this,asm,"<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}+__StaticArrayInitTypeSize=36",true,false,false,false,false,[],[],(asm0)["System.ValueType"](),BLR.is_inst_value_type(this),Array,"asm1.t2000009");
            BLR.declare_virtual(this,"asm0.x6000008","asm0.x6000016");
            BLR.declare_virtual(this,"asm0.x6000005","asm0.x6000005");
            BLR.declare_virtual(this,"asm0.x6000009","asm0.x6000009");
        });
    (asm)["<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}+__StaticArrayInitTypeSize=7"] = BLR.declare_type(
        ...
        {
            this.init = BLR.nop;
            BLR.init_type(this,asm,"<PrivateImplementationDetails>{7B624A4C-AE15-4077-A816-E725CFF01DB8}+__StaticArrayInitTypeSize=7",true,false,false,false,false,[],[],(asm0)["System.ValueType"](),BLR.is_inst_value_type(this),Array,"asm1.t200000a");
            BLR.declare_virtual(this,"asm0.x6000008","asm0.x6000016");
            BLR.declare_virtual(this,"asm0.x6000005","asm0.x6000005");
            BLR.declare_virtual(this,"asm0.x6000009","asm0.x6000009");
        });
