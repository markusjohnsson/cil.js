...
(asm1.x600000f)(st_01,cloneValue(st_02));
/* IL_0E: ldc.i4.0 */
st_03 = 0;
/* IL_0F: stloc.1 */
loc1 = st_03;
...
st_06 = (asm0.x600000c)(st_04,cloneValue(st_05));
/* IL_1C: stloc.2 */
loc2 = st_06;
/* IL_1D: ldloc.2 */
st_07 = loc2;
...
st_19 = (asm0.x600000c)(st_17,cloneValue(st_18));
/* IL_7D: call String EscapeChar(System.Char)*/
st_1B = (asm1.x6000012)(cloneValue(st_19));
...
st_29 = (asm0.x600000c)(st_26,cloneValue(st_27));
/* IL_D2: callvirt Void Append(System.Char)*/
(asm1.x600000f)(st_28,cloneValue(st_29));
case 0xD7:
/* IL_D7: ldloc.1 */
st_2A = loc1;
/* IL_D8: ldc.i4.1 */
...
(asm1.x600000f)(st_30,cloneValue(st_31));
/* IL_EF: ldloc.0 */
st_32 = loc0;
...
st_03 = (asm0.x600000e)(st_01,st_02);
/* IL_10: ret */
return st_03; };
self = (function () { var initialized;
 initialized = false;;
