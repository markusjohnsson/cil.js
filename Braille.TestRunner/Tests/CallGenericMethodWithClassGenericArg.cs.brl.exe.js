    ...
    asm.E = (function ()
    {
        ...
        return function ()
        {
            ...
            E.init = function ()
            {
                ...
                initialized = true;
                initType(E,"E",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(E),Array,"asm1.t2000009");
                E.Interfaces = [];
    ...
    (asm)["A`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            A_1.init = function ()
            {
                ...
                ],((asm0)["System.Object"])(),is_inst_default(A_1),Array,"asm1.t200000a");
                A_1.Interfaces = [];
