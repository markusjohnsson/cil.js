    ...
    (asm)["A`1"] = (function ()
    {
        ...
        return function (T)
        {
            ...
            A_1.init = function ()
            {
                ...
                ],((asm0)["System.Object"])(),is_inst_default(A_1),Array,"asm1.t2000007");
                A_1.Interfaces = [];
    ...
    asm.B = (function ()
    {
        ...
        return function ()
        {
            ...
            B.init = function ()
            {
                ...
                initialized = true;
                initType(B,"B",asm,false,false,false,false,false,[],[],((asm1)["A`1"])((asm1.C)()),is_inst_default(B),Array,"asm1.t2000008");
                B.Interfaces = [];
