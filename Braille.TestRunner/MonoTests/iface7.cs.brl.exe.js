var asm1;(function (asm) 
{
    ...
    (asm)["TestMono.IBase"] = BLR.declare_type("IBase",
        [],
        function () 
        {
            return {};
    ...
    (asm)["TestMono.IDerived"] = BLR.declare_type("IDerived",
        [],
        function () 
        {
            return {};
    ...
    (asm)["TestMono.Base"] = BLR.declare_type("Base",
        [],
        function () 
        {
            return new ((asm0)["System.Object"]())();
    ...
    (asm)["TestMono.Derived"] = BLR.declare_type("Derived",
        [],
        function () 
        {
    ...
    (asm)["TestMono.Class1"] = BLR.declare_type("Class1",
        [],
        function () 
        {
            return new ((asm0)["System.Object"]())();
