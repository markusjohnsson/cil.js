    ...
    asm.TestString = (function ()
    {
        ...
        return function ()
        {
            ...
            TestString.init = function ()
            {
                ...
                initialized = true;
                initType(TestString,"TestString",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(TestString),Array,"asm1.t2000007");
                TestString.Interfaces = [];
                declare_virtual(TestString,"asm0.x6000005","asm0.x6000005");
                declare_virtual(TestString,"asm0.x6000008","asm0.x6000008");
                declare_virtual(TestString,"asm0.x6000009","asm0.x6000009");
            };
