...
;
    ...
    asm.x600000c_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                if ((asm1.x600000e)(t0.TheButton,clone_value(newobj(t2,asm0.x600011f,[ null,(1|0) ]))) === (2|0)){
                    __pos_0__ = 0x15;
                    continue;
                }
                /* IL_13: ldc.i4.1 */
    ...
    asm.x6000010_ = function _cctor()
    {
        ...
        (t0)["TheButton"] = newobj(t0,asm1.x600000f,[ null ]);
        /* IL_0A: ret */
        return ;
    };
