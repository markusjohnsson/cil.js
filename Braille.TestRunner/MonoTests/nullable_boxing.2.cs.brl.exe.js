var asm1; (function (asm)
{
    ...
    asm.x600000c_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                if ((asm1.x600000e)(t1.TheButton,(BLR.clone_value)((BLR.newobj)(t3,asm0.x600015a,[
                    null,
                    (1|0)
                ]))) === (2|0)){
                    __pos_0__ = 0x15;
    ...
    (asm)["Program+Button"] = (BLR.declare_type)("Button",function ()
    {
        this.init = BLR.nop;
        (BLR.init_type)(this,"Program+Button",asm,false,false,false,false,false,[],[
            [
                asm1,
                "x600000e",
                "Counter"
