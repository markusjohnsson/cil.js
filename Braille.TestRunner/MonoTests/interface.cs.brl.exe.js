    ...
    asm.x6000013_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                /* IL_0B: stloc.0 */
                loc0 = newobj(t0,asm1.x600000f,[ null,(0|0),(0|0),(10|0),(20|0) ]);
                /* IL_0C: ldc.i4.0 */
                /* IL_0D: ldc.i4.0 */
                /* IL_0E: ldc.i4.s 20*/
                /* IL_10: newobj Void .ctor(System.Int32, System.Int32, System.Int32)*/
                /* IL_15: stloc.1 */
                loc1 = newobj(t1,asm1.x6000011,[ null,(0|0),(0|0),(20|0) ]);
                /* IL_16: ldloc.0 */
    ...
    (asm)["Obj.Measurable"] = (function ()
    {
        ...
        return function ()
        {
            ...
            Measurable.init = function ()
            {
                ...
                Measurable.IsInst = function (t) { return t.constructor.Interfaces.indexOf(Measurable) != -1 ? t : null; };
