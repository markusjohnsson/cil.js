...
;
    ...
    asm.x600000f = function _ctor(arg0,arg1,arg2,arg3,arg4)
    {
        ...
        st_02 = arg1;
        /* IL_08: stfld Int32 x*/
        st_01.ObjRectx = st_02;
        /* IL_0D: ldarg.0 */
        st_03 = arg0;
        /* IL_0E: ldarg.2 */
        st_04 = arg2;
        /* IL_0F: stfld Int32 y*/
        st_03.ObjRecty = st_04;
        /* IL_14: ldarg.0 */
        st_05 = arg0;
        /* IL_15: ldarg.3 */
        st_06 = arg3;
        /* IL_16: stfld Int32 w*/
        st_05.ObjRectw = st_06;
        /* IL_1B: ldarg.0 */
        st_07 = arg0;
        /* IL_1C: ldarg.s 4*/
        st_08 = arg4;
        /* IL_1E: stfld Int32 h*/
        st_07.ObjRecth = st_08;
        /* IL_23: ret */
        return ;
    };;
    ...
    asm.x6000011 = function _ctor(arg0,arg1,arg2,arg3)
    {
        ...
        st_02 = arg1;
        /* IL_08: stfld Int32 x*/
        st_01.ObjCirclex = st_02;
        /* IL_0D: ldarg.0 */
        st_03 = arg0;
        /* IL_0E: ldarg.2 */
        st_04 = arg2;
        /* IL_0F: stfld Int32 y*/
        st_03.ObjCircley = st_04;
        /* IL_14: ldarg.0 */
        st_05 = arg0;
        /* IL_15: ldarg.3 */
        st_06 = arg3;
        /* IL_16: stfld Int32 r*/
        st_05.ObjCircler = st_06;
        /* IL_1B: ret */
        return ;
    };;
    ...
    asm.x6000013_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                st_04 = new t0();
                (asm1.x600000f)(st_04,st_00,st_01,st_02,st_03);
                /* IL_0B: stloc.0 */
                loc0 = st_04;
                /* IL_0C: ldc.i4.0 */
                st_05 = 0;
                ...
                st_08 = new t1();
                (asm1.x6000011)(st_08,st_05,st_06,st_07);
                /* IL_15: stloc.1 */
                loc1 = st_08;
                /* IL_16: ldloc.0 */
                st_09 = loc0;
                /* IL_17: callvirt Double Area()*/
                st_0B = (((st_09.vtable)["asm1.x600000d"])())(st_09);
                /* IL_1C: ldloc.1 */
                st_0A = loc1;
                /* IL_1D: callvirt Double Area()*/
                st_0C = (((st_0A.vtable)["asm1.x600000d"])())(st_0A);
                /* IL_22: add */
                st_0D = (st_0B + st_0C);
                /* IL_23: stloc.2 */
                loc2 = st_0D;
                ...
                st_1F = (((st_1D)[t2].x600000c)())(st_1D);
                /* IL_68: ldloc.1 */
                st_1E = loc1;
                /* IL_69: callvirt Double Area()*/
                st_20 = (((st_1E)[t2].x600000c)())(st_1E);
                /* IL_6E: add */
                st_21 = (st_1F + st_20);
                /* IL_6F: stloc.2 */
                loc2 = st_21;
    ...
    (asm)["Obj.Measurable"] = (function ()
    {
        ...
        return function ()
        {
            ...
            Measurable.init = function ()
            {
                ...
                Measurable.prototype.vtable = {'asm1.x600000c': function ()
                    {
    ...
    (asm)["Obj.Obj"] = (function ()
    {
        ...
        return function ()
        {
            ...
            Obj.init = function ()
            {
                ...
                Obj.ArrayType = Array;
                Obj.prototype.vtable = {'asm1.x600000d': function ()
                    {
                ...
                (Obj.prototype)[((asm1)["Obj.Measurable"])()] = {'x600000c': function ()
                    {
    ...
    (asm)["Obj.Rect"] = (function ()
    {
        ...
        return function ()
        {
            ...
            Rect.init = function ()
            {
                ...
                Rect.prototype.vtable = {'asm1.x600000d': function ()
                    {
                ...
                (Rect.prototype)[((asm1)["Obj.Measurable"])()] = {'x600000c': function ()
                    {
    ...
    (asm)["Obj.Circle"] = (function ()
    {
        ...
        return function ()
        {
            ...
            Circle.init = function ()
            {
                ...
                Circle.prototype.vtable = {'asm1.x600000d': function ()
                    {
                ...
                (Circle.prototype)[((asm1)["Obj.Measurable"])()] = {'x600000c': function ()
                    {
