...
function IHelloWorldWriter() { 
 if (!initialized){
initialized = true;IHelloWorldWriter.IsValueType = false;IHelloWorldWriter.prototype.vtable = { 
...
function RealWriter() { 
 if (!initialized){
initialized = true;RealWriter.IsValueType = false;RealWriter.prototype.vtable = { 
...
function ProjectName() { 
 if (!initialized){
initialized = true;ProjectName.IsValueType = false;ProjectName.prototype.vtable = { 
'x6000001': asm.x6000001 
};
} };
