    ...
    asm.x600001d_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                /* IL_00: newobj Void .ctor()*/
                /* IL_05: stloc.0 */
                loc0 = newobj(t0,asm1.x6000016,[ null ]);
                /* IL_06: newobj Void .ctor()*/
                /* IL_0B: stloc.1 */
                loc1 = newobj(t1,asm1.x600001b,[ null ]);
                /* IL_0C: newobj Void .ctor()*/
                /* IL_11: stloc.2 */
                loc2 = newobj(t2,asm1.x600001c,[ null ]);
                /* IL_12: ldloc.1 */
                /* IL_13: stloc.3 */
                loc3 = loc1;
                /* IL_14: newobj Void .ctor()*/
                /* IL_19: stloc.s 4*/
                loc4 = newobj(t3,asm1.x6000014,[ null ]);
                /* IL_1B: ldloc.0 */
    ...
    asm.IVehicle = (function ()
    {
        ...
        return function ()
        {
            ...
            IVehicle.init = function ()
            {
                ...
                IVehicle.Interfaces = [  ];
                IVehicle.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IVehicle) != -1 ? t : null; };
    ...
    asm.IWalker = (function ()
    {
        ...
        return function ()
        {
            ...
            IWalker.init = function ()
            {
                ...
                IWalker.Interfaces = [  ];
                IWalker.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IWalker) != -1 ? t : null; };
