    ...
    asm.X = (function ()
    {
        ...
        return function ()
        {
            ...
            X.init = function ()
            {
                ...
                initialized = true;
                initType(X,"X",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(X),Array,"asm1.t2000007");
                X.Interfaces = [];
    ...
    asm.Y = (function ()
    {
        ...
        return function ()
        {
            ...
            Y.init = function ()
            {
                ...
                initialized = true;
                initType(Y,"Y",asm,false,false,false,false,false,[],[],(asm1.X)(),is_inst_default(Y),Array,"asm1.t2000008");
                Y.Interfaces = [];
    ...
    asm.Z = (function ()
    {
        ...
        return function ()
        {
            ...
            Z.init = function ()
            {
                ...
                initialized = true;
                initType(Z,"Z",asm,false,false,false,false,false,[],[],(asm1.Y)(),is_inst_default(Z),Array,"asm1.t2000009");
                Z.Interfaces = [];
    ...
    asm.test = (function ()
    {
        ...
        return function ()
        {
            ...
            test.init = function ()
            {
                ...
                initialized = true;
                initType(test,"test",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),is_inst_default(test),Array,"asm1.t200000a");
                test.global = 0;
                test.Interfaces = [];
