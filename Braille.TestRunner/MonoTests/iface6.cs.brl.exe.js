...
;
    ...
    asm.x6000018_ = function Test(arg0)
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                st_02 = (((st_00)[t0].x600000c)())(st_00,st_01);
                /* IL_07: ldc.i4.5 */
                st_03 = 5;
                /* IL_08: beq.s IL_0C*/
                ...
                st_07 = (((st_05)[t1].x600000d)())(st_05,st_06);
                /* IL_13: ldc.i4.6 */
                st_08 = 6;
                /* IL_14: beq.s IL_18*/
    ...
    asm.x6000019_ = function Test2(arg0)
    {
        ...
        (((st_00)[t0].x600000e)())(st_00);
        /* IL_06: ldarg.0 */
        st_01 = arg0;
        /* IL_07: callvirt Object Clone()*/
        st_02 = (((st_01)[t1].x600006d)())(st_01);
        /* IL_0C: pop */
        /* IL_0D: ldarg.0 */
        st_03 = arg0;
        /* IL_0E: callvirt Void Dispose()*/
        (((st_03)[t2].x600002b)())(st_03);
        /* IL_13: ret */
        return ;
    };
    ...
    asm.IA = (function ()
    {
        ...
        return function ()
        {
            ...
            IA.init = function ()
            {
                ...
                IA.IsNullable = false;
                IA.ArrayType = Array;
                IA.prototype.vtable = {'asm1.x600000c': function ()
                    {
    ...
    asm.IB = (function ()
    {
        ...
        return function ()
        {
            ...
            IB.init = function ()
            {
                ...
                IB.IsNullable = false;
                IB.ArrayType = Array;
                IB.prototype.vtable = {'asm1.x600000d': function ()
                    {
    ...
    asm.IE = (function ()
    {
        ...
        return function ()
        {
            ...
            IE.init = function ()
            {
                ...
                IE.IsNullable = false;
                IE.ArrayType = Array;
                IE.prototype.vtable = {'asm1.x600000e': function ()
                    {
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                D.IsNullable = false;
                D.ArrayType = Array;
                D.prototype.vtable = {'asm1.x600000f': function ()
                    {
                ...
                (D.prototype)[(asm1.IA)()] = {'x600000c': function ()
                    {
                        
                        return asm1.x600000f;
                    }
                };
                (D.prototype)[(asm1.IB)()] = {'x600000d': function ()
                    {
    ...
    asm.E = (function ()
    {
        ...
        return function ()
        {
            ...
            E.init = function ()
            {
                ...
                E.IsNullable = false;
                E.ArrayType = Array;
                E.prototype.vtable = {'asm1.x6000013': function ()
                    {
                ...
                (E.prototype)[(asm1.IE)()] = {'x600000e': function ()
                    {
                        
                        return asm1.x6000013;
                    }
                };
                (E.prototype)[((asm0)["System.ICloneable"])()] = {'x600006d': function ()
                    {
                        
                        return asm1.x6000014;
                    }
                };
                (E.prototype)[((asm0)["System.IDisposable"])()] = {'x600002b': function ()
                    {
                ...
                (E.prototype)[(asm1.IA)()] = {'x600000c': function ()
                    {
                        
                        return asm1.x6000016;
                    }
                };
                (E.prototype)[(asm1.IB)()] = {'x600000d': function ()
                    {
    ...
    asm.C = (function ()
    {
        ...
        return function ()
        {
            ...
            C.init = function ()
            {
                ...
                C.IsNullable = false;
                C.ArrayType = Array;
                C.prototype.vtable = {'asm0.x6000003': function ()
                    {
