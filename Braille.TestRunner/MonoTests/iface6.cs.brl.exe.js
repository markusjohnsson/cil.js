...
;
    ...
    asm.x6000018_ = function Test(arg0)
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                if ((((arg0)[t0].x600000c)())(arg0,(0|0)) === (5|0)){
                    __pos_0__ = 0xC;
                    continue;
                }
                /* IL_0A: ldc.i4.1 */
                ...
                if ((((arg0)[t1].x600000d)())(arg0,(0|0)) === (6|0)){
                    __pos_0__ = 0x18;
                    continue;
                }
                /* IL_16: ldc.i4.1 */
    ...
    asm.x6000019_ = function Test2(arg0)
    {
        ...
        (((arg0)[t0].x600000e)())(arg0);
        /* IL_06: ldarg.0 */
        /* IL_07: callvirt Object Clone()*/
        /* IL_0C: pop */
        (((arg0)[t1].x6000068)())(arg0);
        /* IL_0D: ldarg.0 */
        /* IL_0E: callvirt Void Dispose()*/
        (((arg0)[t2].x6000069)())(arg0);
        /* IL_13: ret */
        return ;
    };
    ...
    asm.x600001a_ = function Main()
    {
        ...
        /* IL_00: newobj Void .ctor()*/
        /* IL_05: stloc.0 */
        loc0 = newobj(t0,asm1.x6000011,[ null ]);
        /* IL_06: newobj Void .ctor()*/
        /* IL_0B: stloc.1 */
        loc1 = newobj(t1,asm1.x6000012,[ null ]);
        /* IL_0C: ldloc.1 */
    ...
    asm.IA = (function ()
    {
        ...
        return function ()
        {
            ...
            IA.init = function ()
            {
                ...
                IA.Assembly = asm;
                IA.Interfaces = [  ];
                IA.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IA) != -1 ? t : null; };
    ...
    asm.IB = (function ()
    {
        ...
        return function ()
        {
            ...
            IB.init = function ()
            {
                ...
                IB.Assembly = asm;
                IB.Interfaces = [  ];
                IB.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IB) != -1 ? t : null; };
    ...
    asm.IC = (function ()
    {
        ...
        return function ()
        {
            ...
            IC.init = function ()
            {
                ...
                IC.FullName = "IC";
                IC.Assembly = asm;
                IC.Interfaces = [ (asm1.IA)(),(asm1.IB)() ];
                IC.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IC) != -1 ? t : null; };
    ...
    asm.IE = (function ()
    {
        ...
        return function ()
        {
            ...
            IE.init = function ()
            {
                ...
                IE.FullName = "IE";
                IE.Assembly = asm;
                IE.Interfaces = [ ((asm0)["System.ICloneable"])(),((asm0)["System.IDisposable"])() ];
                IE.IsInst = function (t) { return t.constructor.Interfaces.indexOf(IE) != -1 ? t : null; };
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                D.FullName = "D";
                D.Assembly = asm;
                D.Interfaces = [ (asm1.IC)(),(asm1.IA)(),(asm1.IB)() ];
    ...
    asm.E = (function ()
    {
        ...
        return function ()
        {
            ...
            E.init = function ()
            {
                ...
                E.FullName = "E";
                E.Assembly = asm;
                E.Interfaces = [ (asm1.IE)(),((asm0)["System.ICloneable"])(),((asm0)["System.IDisposable"])(),(asm1.IC)(),(asm1.IA)(),(asm1.IB)() ];
                ...
                (E.prototype)[((asm0)["System.ICloneable"])()] = {
                    'x6000068': function ()
                    {
                        return asm1.x6000014;
                    }
                };
                (E.prototype)[((asm0)["System.IDisposable"])()] = {
                    'x6000069': function ()
                    {
                        return asm1.x6000015;
                    }
