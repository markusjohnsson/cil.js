    ...
    asm.Point = (function ()
    {
        ...
        return function ()
        {
            ...
            Point.init = function ()
            {
                ...
                Point.Methods = [];
                Point.BaseType = ((asm0)["System.ValueType"])();
                Point.FullName = "Point";
                Point.Assembly = asm;
                Point.Interfaces = [];
                Point.IsInst = function (t) { return t instanceof Point ? t : null; };
                Point.IsValueType = true;
                Point.IsPrimitive = false;
                Point.IsInterface = false;
                Point.IsGenericTypeDefinition = false;
                Point.IsNullable = false;
                Point.ArrayType = Array;
                Point.prototype.x = 0;
                Point.prototype.y = 0;
                Point.prototype.z = 0;
