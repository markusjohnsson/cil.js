    ...
    asm.Point = (function ()
    {
        ...
        return function ()
        {
            ...
            Point.init = function ()
            {
                ...
                initialized = true;
                (BLR.init_type)(Point,"Point",asm,true,false,false,false,false,[],[],((asm0)["System.ValueType"])(),(BLR.is_inst_default)(Point),Array,"asm1.t2000007");
                Point.Interfaces = [];
                (BLR.declare_virtual)(Point,"asm0.x6000008","asm0.x6000016");
                (BLR.declare_virtual)(Point,"asm0.x6000005","asm0.x6000005");
                (BLR.declare_virtual)(Point,"asm0.x6000009","asm0.x6000009");
                Point.prototype.x = 0;
                Point.prototype.y = 0;
                Point.prototype.z = 0;
            };
    ...
    asm.test = (function ()
    {
        ...
        return function ()
        {
            ...
            test.init = function ()
            {
                ...
                initialized = true;
                (BLR.init_type)(test,"test",asm,false,false,false,false,false,[],[],((asm0)["System.Object"])(),(BLR.is_inst_default)(test),Array,"asm1.t2000008");
                test.Interfaces = [];
