    ...
    asm.Point = (function ()
    {
        ...
        return function ()
        {
            ...
            Point.init = function ()
            {
                ...
                Point.MetadataName = "asm1.t2000007";
                Point.GenericArguments = {};
                (Point.GenericArguments)["asm1.t2000007"] = [];
                (Point.GenericArguments)["asm0.t2000006"] = [];
                (Point.GenericArguments)["asm0.t2000002"] = [];
                Point.prototype.x = 0;
                Point.prototype.y = 0;
                Point.prototype.z = 0;
    ...
    asm.test = (function ()
    {
        ...
        return function ()
        {
            ...
            test.init = function ()
            {
                ...
                test.MetadataName = "asm1.t2000008";
                test.GenericArguments = {};
                (test.GenericArguments)["asm1.t2000008"] = [];
