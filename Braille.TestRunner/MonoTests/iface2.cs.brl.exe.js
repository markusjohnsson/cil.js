    ...
    asm.x600001a_ = function Main()
    {
        ...
        while (__pos_0__ >= 0){
            ...
            switch (__pos_0__){
                ...
                /* IL_00: newobj Void .ctor()*/
                /* IL_05: stloc.0 */
                loc0 = newobj(t0,asm1.x6000013,[ null ]);
                /* IL_06: newobj Void .ctor()*/
                /* IL_0B: pop */
                newobj(t1,asm1.x6000018,[ null ]);
                /* IL_0C: ldloc.0 */
    ...
    asm.ID = (function ()
    {
        ...
        return function ()
        {
            ...
            ID.init = function ()
            {
                ...
                ID.FullName = "ID";
                ID.Assembly = asm;
                ID.Interfaces = [ (asm1.IA)(),(asm1.IB)() ];
                ID.IsInst = function (t) { return t.constructor.Interfaces.indexOf(ID) != -1 ? t : null; };
    ...
    asm.D = (function ()
    {
        ...
        return function ()
        {
            ...
            D.init = function ()
            {
                ...
                D.FullName = "D";
                D.Assembly = asm;
                D.Interfaces = [ (asm1.ID)(),(asm1.IA)(),(asm1.IB)() ];
    ...
    asm.E = (function ()
    {
        ...
        return function ()
        {
            ...
            E.init = function ()
            {
                ...
                E.FullName = "E";
                E.Assembly = asm;
                E.Interfaces = [ (asm1.IC)(),(asm1.ID)(),(asm1.IA)(),(asm1.IB)() ];
