...
(asm1.x600000f)(result,cloneValue(st_00),cloneValue(st_01),cloneValue(st_02),cloneValue(st_03));
return result; })();
/* IL_0B: stloc.0 */
loc0 = st_04;
/* IL_0C: ldc.i4.0 */
...
(asm1.x6000011)(result,cloneValue(st_05),cloneValue(st_06),cloneValue(st_07));
return result; })();
/* IL_15: stloc.1 */
loc1 = st_08;
/* IL_16: ldloc.0 */
