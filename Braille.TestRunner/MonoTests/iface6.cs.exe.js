...
st_02 = (st_00.IA.x600000c)(st_00,cloneValue(st_01));
/* IL_07: ldc.i4.5 */
st_03 = 5;
/* IL_08: beq.s IL_0C*/
if (st_02 === st_03){
...
st_07 = (st_05.IB.x600000d)(st_05,cloneValue(st_06));
/* IL_13: ldc.i4.6 */
st_08 = 6;
/* IL_14: beq.s IL_18*/
if (st_07 === st_08){
...
st_02 = ((st_01)["System.ICloneable"].x600001a)(st_01);
/* IL_0C: pop */
/* IL_0D: ldarg.0 */
st_03 = __braille_args__[0];
/* IL_0E: callvirt Void Dispose()*/
((st_03)["System.IDisposable"].x6000019)(st_03);
/* IL_13: ret */
return ; };
...
'x600001a': asm1.x6000014 
};
(E.prototype)["System.IDisposable"] = { 
'x6000019': asm1.x6000015 
};
E.prototype.IC = { 
