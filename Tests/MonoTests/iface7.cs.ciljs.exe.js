...
asm.FullName = "iface7.cs.ciljs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";/* System.Int32 Base.TestMono.IBase.Do()*/
...
asm.x6000002 = function TestMono_IBase_Do(arg0)
{
    ...
    loc0 = (1 + (arg0.vtable)["asm1.x6000003"](arg0)) | 0;
    /* IL_0C: ldloc.0  */
    /* IL_0D: ret  */
...
asm.x6000005 = function _ctor(arg0)
{
    ...
    return ;
};;/* static System.Int32 Class1.Main()*/
...
asm.x6000006_ = function Main()
{
    ...
    while (in_block_0){
        ...
        switch (__pos__){
            ...
            loc4 = ((((((loc0.ifacemap)[t1].x6000001)(CILJS.convert_box_to_pointer_as_needed(loc0)) === 2) ? 1 : 0) === 0) ? 1 : 0);
            /* IL_15: ldloc.s 4 */
            ...
            loc6 = ((((((loc1.ifacemap)[t1].x6000001)(CILJS.convert_box_to_pointer_as_needed(loc1)) === 2) ? 1 : 0) === 0) ? 1 : 0);
            /* IL_2E: ldloc.s 6 */
            ...
            loc7 = (((((loc2.vtable)["asm1.x6000003"](loc2) === 1) ? 1 : 0) === 0) ? 1 : 0);
            /* IL_4C: ldloc.s 7 */
            ...
            loc8 = (((((loc3.vtable)["asm1.x6000003"](loc3) === 1) ? 1 : 0) === 0) ? 1 : 0);
            /* IL_6A: ldloc.s 8 */
...
asm["TestMono.IBase"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"TestMono.IBase",false,false,true,false,false,[],[
                [asm1, "x6000001", "Do"]
...
asm["TestMono.IDerived"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"TestMono.IDerived",false,false,true,false,false,[],[],null,CILJS.is_inst_interface(type),Array,"asm1.t2000003",null);
...
asm["TestMono.Base"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"TestMono.Base",false,false,false,false,false,[],[
                [asm1, "x6000003", "Do"]
...
asm["TestMono.Derived"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"TestMono.Derived",false,false,false,false,false,[],[],asm1["TestMono.Base"](),CILJS.is_inst_default(type),Array,"asm1.t2000005",null);
...
asm["TestMono.Class1"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"TestMono.Class1",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000006",null);
...
CILJS.declare_assembly("iface7.cs.ciljs",asm);
if (typeof module != "undefined"){
    
    module.exports = asm1;
}
//# sourceMappingURL=iface7.cs.ciljs.exe.js.map
