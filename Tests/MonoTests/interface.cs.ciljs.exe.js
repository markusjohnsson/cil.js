...
asm.FullName = "interface.cs.ciljs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";/* System.Double Obj.Area()*/
...
asm.x6000008_ = function Main()
{
    ...
    while (in_block_0){
        ...
        switch (__pos__){
            ...
            loc0 = CILJS.newobj(t0,asm1.x6000004,[null, 0, 0, 10, 20]);
            /* IL_0D: ldc.i4.0  */
            /* IL_0E: ldc.i4.0  */
            /* IL_0F: ldc.i4.s 20 */
            ...
            loc1 = CILJS.newobj(t1,asm1.x6000006,[null, 0, 0, 20]);
            /* IL_17: ldloc.0  */
...
asm["Obj.Measurable"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Obj.Measurable",false,false,true,false,false,[],[
                [asm1, "x6000001", "Area"]
...
asm["Obj.Obj"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Obj.Obj",false,false,false,false,false,[],[
                [asm1, "x6000002", "Area"]
...
asm["Obj.Rect"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Obj.Rect",false,false,false,false,false,[],[
                [asm1, "x6000005", "Area"]
            ],asm1["Obj.Obj"](),CILJS.is_inst_default(type),Array,"asm1.t2000004",null);
...
asm["Obj.Circle"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Obj.Circle",false,false,false,false,false,[],[
                [asm1, "x6000007", "Area"]
            ],asm1["Obj.Obj"](),CILJS.is_inst_default(type),Array,"asm1.t2000005",null);
...
asm["Obj.Test"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Obj.Test",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000006",null);
...
CILJS.declare_assembly("interface.cs.ciljs",asm);
if (typeof module != "undefined"){
    
    module.exports = asm1;
}
//# sourceMappingURL=interface.cs.ciljs.exe.js.map
