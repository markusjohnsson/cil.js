...
asm.FullName = "struct.cs.ciljs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";/* static Point Point.get_zerop()*/
...
asm.x6000003 = function struct_param(arg0)
{
    ...
    while (in_block_0){
        ...
        switch (__pos__){
            ...
            st_0B = ((CILJS.unsigned_value(arg0.z) > CILJS.unsigned_value(0)) ? 1 : 0);
            /* IL_26: br.s IL_29 */
...
asm.x6000004 = function Main()
{
    ...
    while (in_block_0){
        ...
        switch (__pos__){
            ...
            st_52 = ((CILJS.unsigned_value(loc2.z) > CILJS.unsigned_value(0)) ? 1 : 0);
            /* IL_114: br.s IL_117 */
            ...
            loc13 = ((CILJS.unsigned_value(asm1.x6000003(CILJS.clone_value(loc2))) > CILJS.unsigned_value(0)) ? 1 : 0);
            /* IL_12E: ldloc.s 13 */
            ...
            st_66 = ((CILJS.unsigned_value(loc2.z) > CILJS.unsigned_value(0)) ? 1 : 0);
            /* IL_15D: br.s IL_160 */
...
asm.Point = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Point",true,false,false,false,false,[],[],asm0["System.ValueType"](),CILJS.is_inst_value_type(type),Array,"asm1.t2000002",new (asm1.Point())());
...
asm.test = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"test",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000003",null);
