...
asm.FullName = "ArraySetValue.cs.ciljs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";/* System.String A.GetValue()*/
...
asm.x6000003 = function GetValue(arg0)
{
    ...
    loc0 = (arg0.V.vtable)["asm0.x600009b"](arg0.V);
    /* IL_0F: ldloc.0  */
    /* IL_10: ret  */
...
asm.x6000005 = function ObjectArray()
{
    ...
    asm0.x6000106(loc0,CILJS.makeBox(1,t1),0);
    /* IL_15: nop  */
    /* IL_16: ldloc.0  */
    /* IL_17: ldc.i4.0  */
    /* IL_18: ldelem.ref  */
    ...
    asm0.x6000072(CILJS.ldelemRef(loc0,0));
    /* IL_1E: nop  */
    /* IL_1F: ldloc.0  */
    /* IL_20: ldstr test */
    /* IL_25: ldc.i4.0  */
    ...
    asm0.x6000106(loc0,CILJS.newString("test"),0);
    /* IL_2B: nop  */
    /* IL_2C: ldloc.0  */
    /* IL_2D: ldc.i4.0  */
    /* IL_2E: ldelem.ref  */
...
asm.x6000006_ = function ValueTypeArray()
{
    ...
    st_0E = CILJS.makeBox(CILJS.cloneValue(st_0C),t2);
    /* IL_37: ldc.i4.0  */
    
    st_0F = 0;
    /* IL_38: callvirt Void SetValue(System.Object, System.Int32) */
    
    asm0.x6000106(st_0D,st_0E,st_0F);
    /* IL_3D: nop  */
    /* IL_3E: ldloc.0  */
    /* IL_3F: ldc.i4.0  */
    /* IL_40: ldelem.ref  */
    ...
    asm0.x6000072(CILJS.makeBox(CILJS.ldelemRef(loc0,0).boxed.V,t1));
    /* IL_55: nop  */
    /* IL_56: ldloc.0  */
    /* IL_57: ldnull  */
    /* IL_58: ldc.i4.0  */
...
asm.x6000007_ = function InterfaceArray()
{
    ...
    st_07 = CILJS.makeBox(CILJS.cloneValue(st_05),t1);
    /* IL_20: ldc.i4.0  */
    
    st_08 = 0;
    /* IL_21: callvirt Void SetValue(System.Object, System.Int32) */
    
    asm0.x6000106(st_06,st_07,st_08);
    /* IL_26: nop  */
    /* IL_27: ldloc.0  */
    /* IL_28: ldc.i4.0  */
    /* IL_29: ldelem.ref  */
    ...
    asm0.x6000073(((CILJS.ldelemRef(loc0,0).ifacemap)[t0].x6000001)(CILJS.convertBoxToPointerAsNeeded(CILJS.ldelemRef(loc0,0))),CILJS.newArray(t2,0));
    /* IL_3A: nop  */
    /* IL_3B: ldloc.0  */
    ...
    asm0.x6000106(st_12,st_13,st_14);
    /* IL_52: nop  */
    /* IL_53: ldloc.0  */
    /* IL_54: ldc.i4.0  */
    /* IL_55: ldelem.ref  */
...
asm.x6000008_ = function AArray()
{
    ...
    st_07 = CILJS.makeBox(CILJS.cloneValue(st_05),t0);
    /* IL_20: ldc.i4.0  */
...
asm.A = CILJS.declareType(
    ...
    function (type)
    {
        ...
        CILJS.initType(type,asm,"A",true,false,false,false,false,[],[
                [asm1, "x6000002", "GetValue"]
            ],asm0["System.ValueType"](),CILJS.isInstValueType(type),Array,"asm1.t2000003",new (asm1.A())());
...
CILJS.declareAssembly("ArraySetValue.cs.ciljs",asm);
