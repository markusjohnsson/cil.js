...
asm.FullName = "Structs.cs.ciljs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";/* static System.Void Program.Main()*/
...
asm.x6000001_ = function Main()
{
    ...
    asm1.x6000006(CILJS.cloneValue(loc0));
    /* IL_1B: nop  */
    /* IL_1C: ldloc.0  */
    /* IL_1D: call Void Mutate(A) */
    
    asm1.x6000002(CILJS.cloneValue(loc0));
    /* IL_22: nop  */
    /* IL_23: ldloc.0  */
    ...
    asm1.x6000003(CILJS.makeBox(CILJS.cloneValue(loc0),t0));
    /* IL_35: nop  */
    /* IL_36: ldloc.0  */
    ...
    (asm1.x6000004(asm1.A()))(CILJS.cloneValue(loc0));
    /* IL_43: nop  */
    /* IL_44: ldloc.0  */
...
asm.x6000002 = function Mutate(arg0)
{
    ...
    asm1.x6000006(CILJS.cloneValue(arg0));
    /* IL_1E: nop  */
    /* IL_1F: ldloc.0  */
...
asm.x6000003 = function MutateBoxed(arg0)
{
    ...
    loc0 = CILJS.cloneValue(CILJS.unboxAny(arg0,asm1.A()));
    /* IL_08: ldloca.s 0 */
    /* IL_0A: ldc.i4 333 */
    ...
    loc1 = CILJS.cloneValue(CILJS.unboxAny(arg0,asm1.A()));
    /* IL_1B: ldloca.s 1 */
    /* IL_1D: ldc.i4 444 */
    ...
    asm1.x6000006(CILJS.cloneValue(loc1));
    /* IL_34: nop  */
    /* IL_35: ret  */
...
asm.x6000004 = function (T)
{
    ...
    return function MutateGeneric(arg0)
    {
        ...
        loc0 = CILJS.cloneValue(CILJS.unboxAny(CILJS.box(arg0,t0),asm1.A()));
        /* IL_0D: ldloca.s 0 */
        /* IL_0F: ldc.i4 555 */
        ...
        loc1 = CILJS.cloneValue(CILJS.unboxAny(CILJS.box(arg0,t0),asm1.A()));
        /* IL_25: ldloca.s 1 */
        /* IL_27: ldc.i4 666 */
...
asm.x6000005_ = function MutateField(arg0)
{
    ...
    asm1.x6000006(CILJS.cloneValue(t0.sfield));
    /* IL_33: nop  */
    /* IL_34: ret  */
...
asm.x6000006 = function Print(arg0)
{
    ...
    asm0.x6000072(CILJS.makeBox(arg0.Value,t0));
    /* IL_11: nop  */
    /* IL_12: ret  */
...
CILJS.declareAssembly("Structs.cs.ciljs",asm);
