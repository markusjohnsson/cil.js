...
asm.x6000004_ = function Main()
{
    ...
    asm0.x6000073(((asm1.x6000001(loc0).vtable)["asm0.x60001ca"])(asm1.x6000001(loc0)),CILJS.newArray(t1,0));
    /* IL_1D: nop  */
    /* IL_1E: ret  */
...
asm.B = CILJS.declareType(
    ...
    function (type)
    {
        ...
        CILJS.initType(type,asm,"B",false,false,false,false,false,[],[],asm1["A`1"](asm0["System.Int32"]()),CILJS.isInstDefault(type),Array,"asm1.t2000003",null);
...
CILJS.declareAssembly("GenericInherit.cs.ciljs",asm);
