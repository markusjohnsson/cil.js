...
asm.x6000002_ = function Main()
{
    ...
    (asm1.x6000007(asm0["System.Int32"](),asm0["System.String"]()))(123,CILJS.new_string("C"));
    /* IL_3D: nop  */
    ...
    (asm1.x6000008(asm0["System.Int32"]()))(CILJS.newobj(t3,asm1.x6000009,[null]),CILJS.new_string("C"),321);
    /* IL_52: nop  */
    /* IL_53: ret  */
...
asm.x6000005 = function Foo(arg0, arg1)
{
    ...
    asm0.x60000a1(CILJS.box(arg1,t0));
    /* IL_0C: nop  */
    /* IL_0D: ldarga.s 1 */
    ...
    asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg1,t0)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg1,t0))),CILJS.new_array(t1,0));
    /* IL_2A: nop  */
    /* IL_2B: ret  */
...
asm.x6000006 = function (T)
{
    ...
    return function Bar(arg0)
    {
        ...
        asm0.x60000a1(CILJS.box(arg0,t0));
        /* IL_0C: nop  */
        /* IL_0D: ldarga.s 0 */
        /* IL_15: callvirt Type GetType() */
        /* IL_1A: callvirt String get_FullName() */
        ...
        asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg0,t0)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg0,t0))),CILJS.new_array(t1,0));
        /* IL_2A: nop  */
        /* IL_2B: ret  */
...
asm.x6000007 = function (T, T2)
{
    ...
    return function Baz(arg0, arg1)
    {
        ...
        asm0.x60000a1(CILJS.box(arg1,t1));
        /* IL_18: nop  */
        /* IL_19: ldarga.s 0 */
        ...
        asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg0,t0)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg0,t0))),CILJS.new_array(t2,0));
        /* IL_36: nop  */
        /* IL_37: ldarga.s 1 */
        ...
        asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg1,t1)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg1,t1))),CILJS.new_array(t2,0));
        /* IL_54: nop  */
        /* IL_55: ret  */
...
asm.x6000008 = function (T2)
{
    ...
    return function Buz(arg0, arg1, arg2)
    {
        ...
        asm0.x60000a1(CILJS.box(arg2,t1));
        /* IL_18: nop  */
        /* IL_19: ldarga.s 1 */
        /* IL_21: callvirt Type GetType() */
        /* IL_26: callvirt String get_FullName() */
        ...
        asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg1,t0)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg1,t0))),CILJS.new_array(t2,0));
        /* IL_36: nop  */
        /* IL_37: ldarga.s 2 */
        /* IL_3F: callvirt Type GetType() */
        /* IL_44: callvirt String get_FullName() */
        ...
        asm0.x60000a2(((asm0.x60000cf(CILJS.box(arg2,t1)).vtable)["asm0.x6000073"])(asm0.x60000cf(CILJS.box(arg2,t1))),CILJS.new_array(t2,0));
        /* IL_54: nop  */
        /* IL_55: ret  */
...
asm["A`1+B"] = CILJS.declare_type(
    ...
    function (type, T)
    {
        ...
        CILJS.init_type(type,asm,"A`1+B",false,false,false,true,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000004",null);
...
asm["A`1+B+C"] = CILJS.declare_type(
    ...
    function (type, T)
    {
        ...
        CILJS.init_type(type,asm,"A`1+B+C",false,false,false,true,false,[],[
                [asm1, "x6000005", "Foo"],
                [asm1, "x6000008", "Buz"]
...
CILJS.declare_assembly("GenericNesting2.cs.ciljs",asm);
