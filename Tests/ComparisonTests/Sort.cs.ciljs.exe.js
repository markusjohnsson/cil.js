...
asm.Baz = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.declare_virtual(type,"asm0.x60000ce",asm1,"x6000004");
        
        CILJS.declare_virtual(type,"asm0.x60000cd",asm1,"x6000005");
        
        CILJS.declare_virtual(type,"asm0.x60000ca",asm1,"x6000006");
    },
    function ()
    {
