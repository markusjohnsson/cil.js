...
asm.x6000001 = function Main()
{
    ...
    asm1.x6000002(CILJS.makeBox(0,t1),CILJS.makeBox(0,t1));
    /* IL_36: nop  */
    /* IL_37: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t1),CILJS.makeBox(1,t1));
    /* IL_48: nop  */
    /* IL_49: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t2),CILJS.makeBox(1,t2));
    /* IL_7E: nop  */
    /* IL_7F: ldc.i4.1  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t2),CILJS.makeBox(0,t2));
    /* IL_90: nop  */
    /* IL_91: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t2),CILJS.makeBox(1,t2));
    /* IL_A2: nop  */
    /* IL_A3: ldc.i4.0  */
            ...
            try {
                ...
                while (in_block_1){
                    ...
                    switch (__pos__){
                        ...
                        asm0.x6000072(CILJS.makeBox(((arg0.ifacemap)[t0].x60000da)(CILJS.convertBoxToPointerAsNeeded(arg0),arg1),t1));
                        /* IL_13: nop  */
                        /* IL_14: nop  */
                        /* IL_15: leave.s IL_3F */
                ...
                if ((!(__error_handled_1__)) && (__error__ instanceof asm0["System.Exception"]())){
                    ...
                    while (in_block_1){
                        ...
                        switch (__pos__){
                            ...
                            asm0.x6000073(CILJS.newString("threw"),CILJS.newArray(t2,0));
                            /* IL_29: nop  */
                            /* IL_2A: ldloc.0  */
                            ...
                            asm0.x6000073((loc0.vtable)["asm0.x600007a"](loc0),CILJS.newArray(t2,0));
                            /* IL_3B: nop  */
                            /* IL_3C: nop  */
                            /* IL_3D: leave.s IL_3F */
...
CILJS.declareAssembly("PrimitiveCompareTo.cs.ciljs",asm);
