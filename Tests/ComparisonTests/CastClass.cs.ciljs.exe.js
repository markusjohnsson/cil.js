                ...
                try {
                    ...
                    while (in_block_1){
                        ...
                        switch (__pos__){
                            ...
                            asm0.x6000073(CILJS.new_string("Success"),CILJS.new_array(t1,0));
                            /* IL_1E: nop  */
                            /* IL_1F: nop  */
                            /* IL_20: leave.s IL_38 */
                    ...
                    if ((!(__error_handled_1__)) && (__error__ instanceof asm0["System.Object"]())){
                        ...
                        while (in_block_1){
                            ...
                            switch (__pos__){
                                ...
                                asm0.x6000073(CILJS.new_string("Failure"),CILJS.new_array(t1,0));
                                /* IL_34: nop  */
                                /* IL_35: nop  */
                                /* IL_36: leave.s IL_38 */
...
CILJS.declare_assembly("CastClass.cs.ciljs",asm);
