...
asm.x6000005_ = function AsA(arg0)
{
    ...
    while (in_block_0){
        ...
        switch (__pos__){
            ...
            st_03 = CILJS.newString("not null");
            /* IL_0E: br.s IL_15 */
    ...
    return function As(arg0)
    {
        ...
        while (in_block_0){
            ...
            switch (__pos__){
                ...
                if ((!(CILJS.box(CILJS.unboxAny(t0.IsInst(arg0),t0),t0)))){
                ...
                st_05 = CILJS.newString("not null");
                /* IL_18: br.s IL_1F */
...
CILJS.declareAssembly("As.cs.ciljs",asm);
