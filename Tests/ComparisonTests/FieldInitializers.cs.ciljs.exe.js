...
asm.x6000001_ = function Main()
{
    ...
    asm0.x6000072(CILJS.make_box(t0.X,t1));
    /* IL_10: nop  */
    ...
    asm0.x6000072(CILJS.make_box(CILJS.newobj(t0,asm1.x6000002,[null]).Y,t1));
    /* IL_25: nop  */
    /* IL_26: ret  */
...
CILJS.declare_assembly("FieldInitializers.cs.ciljs",asm);
