...
asm.x6000005 = function M()
{
    ...
    asm0.x6000073(CILJS.new_string("A.B.M"),CILJS.new_array(t0,0));
    /* IL_11: nop  */
    /* IL_12: ret  */
...
asm.x6000006 = function X(arg0)
{
    ...
    asm0.x6000073(CILJS.new_string("A.B.X"),CILJS.new_array(t0,0));
    /* IL_11: nop  */
    /* IL_12: ret  */
...
asm.C = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"C",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000003",null);
...
asm["A+B"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"A+B",false,false,false,false,false,[],[
                [asm1, "x6000006", "X"]
...
asm["C+D"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"C+D",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000006",null);
...
asm["C+D+E"] = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"C+D+E",false,false,false,false,false,[],[
                [asm1, "x6000009", "Y"]
...
CILJS.declare_assembly("NestedClasses.cs.ciljs",asm);
