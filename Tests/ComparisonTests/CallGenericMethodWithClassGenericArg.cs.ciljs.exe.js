...
asm.x6000004 = function (T)
{
    ...
    return function Log(arg0)
    {
        ...
        asm0.x6000072(CILJS.make_box(((t0.IsInst(arg0) !== null) ? 1 : 0),t1));
        /* IL_14: nop  */
        /* IL_15: ret  */
...
asm.E = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"E",false,false,false,false,false,[],[],asm0["System.Object"](),CILJS.is_inst_default(type),Array,"asm1.t2000004",null);
...
CILJS.declare_assembly("CallGenericMethodWithClassGenericArg.cs.ciljs",asm);
