...
asm.x6000005_ = function Main()
{
    ...
    asm0.x6000072(CILJS.make_box(((asm0.x6000045(CILJS.new_handle(asm0["System.RuntimeTypeHandle"](),t2)) === asm0.x6000045(CILJS.new_handle(asm0["System.RuntimeTypeHandle"](),t5))) ? 1 : 0),t6));
    /* IL_21: nop  */
    /* IL_22: ret  */
