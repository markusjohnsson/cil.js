...
asm.x6000001 = function Main()
{
    ...
    asm1.x6000002(CILJS.makeBox(0,t0),CILJS.makeBox(0,t0));
    /* IL_12: nop  */
    /* IL_13: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t0),CILJS.makeBox(1,t0));
    /* IL_24: nop  */
    /* IL_25: ldc.i4.1  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t0),CILJS.makeBox(1,t1));
    /* IL_36: nop  */
    /* IL_37: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t0),CILJS.makeBox(0,t2));
    /* IL_48: nop  */
    /* IL_49: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t2),CILJS.makeBox(0,t0));
    /* IL_5A: nop  */
    /* IL_5B: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t2),CILJS.makeBox(1,t0));
    /* IL_6C: nop  */
    /* IL_6D: ldc.i4.1  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t2),CILJS.makeBox(1000,t1));
    /* IL_82: nop  */
    /* IL_83: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t2),CILJS.makeBox(0,t2));
    /* IL_94: nop  */
    /* IL_95: ldc.i4 255 */
    ...
    asm1.x6000002(CILJS.makeBox(255,t0),CILJS.makeBox(-1,t2));
    /* IL_AA: nop  */
    /* IL_AB: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t3),CILJS.makeBox(1,t3));
    /* IL_F6: nop  */
    /* IL_F7: ldc.i4.1  */
    ...
    asm1.x6000002(CILJS.makeBox(1,t3),CILJS.makeBox(0,t3));
    /* IL_108: nop  */
    /* IL_109: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t3),CILJS.makeBox(1,t3));
    /* IL_11A: nop  */
    /* IL_11B: ldc.i4.0  */
    ...
    asm1.x6000002(CILJS.makeBox(0,t3),CILJS.makeBox(0,t3));
    /* IL_12C: nop  */
    /* IL_12D: ret  */
...
asm.x6000002 = function Test(arg0, arg1)
{
    ...
    asm0.x6000072(CILJS.makeBox((arg0.vtable)["asm0.x600009e"](CILJS.convertBoxToPointerAsNeeded(arg0),arg1),t0));
    /* IL_12: nop  */
    /* IL_13: ret  */
...
CILJS.declareAssembly("PrimitiveEquals.cs.ciljs",asm);
