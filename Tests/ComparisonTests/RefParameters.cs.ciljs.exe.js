...
asm.x6000005_ = function Main()
{
    ...
    asm0.x60000a1(CILJS.make_box(loc0,t2));
    /* IL_45: nop  */
    /* IL_46: ldloc.1  */
    /* IL_47: ldfld Int32 U */
    ...
    asm0.x60000a1(CILJS.make_box(loc1.U,t2));
    /* IL_56: nop  */
    /* IL_57: ldloc.2  */
    /* IL_58: ldfld Int32 V */
    ...
    asm0.x60000a1(CILJS.make_box(loc2.V,t2));
    /* IL_67: nop  */
    /* IL_68: ret  */
...
CILJS.declare_assembly("RefParameters.cs.ciljs",asm);
