...
asm.x6000006_ = function Main()
{
    ...
    asm0.x60000a1(CILJS.make_box(((loc0.Value === null) ? 1 : 0),t2));
    /* IL_22: nop  */
    /* IL_23: ldloc.0  */
    ...
    asm0.x60000a1(CILJS.make_box(((loc0.Array === null) ? 1 : 0),t2));
    /* IL_36: nop  */
    ...
    asm0.x60000a1(CILJS.make_box(((loc1.Value === null) ? 1 : 0),t2));
    /* IL_58: nop  */
    /* IL_59: ldloc.1  */
    ...
    asm0.x60000a1(CILJS.make_box(((loc1.Array === null) ? 1 : 0),t2));
    /* IL_6C: nop  */
    /* IL_6D: ret  */
...
asm["B`1"] = CILJS.declare_type(
    ...
    function (type, T)
    {
        ...
        CILJS.init_type(type,asm,"B`1",false,false,false,true,false,[],[
                [asm1, "x6000002", "Foo"]
...
CILJS.declare_assembly("MethodInitializerBug2.cs.ciljs",asm);
