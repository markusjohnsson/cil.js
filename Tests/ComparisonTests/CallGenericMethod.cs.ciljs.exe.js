...
asm.x6000008_ = function (T)
{
    ...
    return function X(arg0)
    {
        ...
        asm0.x6000072(CILJS.box((((arg0.ifacemap)[t1])[t0].x6000001)(CILJS.convert_box_to_pointer_as_needed(arg0)),t0));
        /* IL_11: nop  */
        /* IL_12: ret  */
...
CILJS.declare_assembly("CallGenericMethod.cs.ciljs",asm);
