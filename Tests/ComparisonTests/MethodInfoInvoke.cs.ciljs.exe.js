var asm1;(function (asm)
{
    ...
    asm.x6000002 = function X(arg0, arg1)
    {
        ...
        /* IL_1A: stloc.0  */
        loc0 = asm0.x6000109(arg0.AY,arg1);
        /* IL_1D: ldloc.0  */
        /* IL_1E: ret  */
        return loc0;
    };;
    ...
    asm.x6000003_ = function Main()
    {
        ...
        /* IL_16: ldelem.ref  */
        /* IL_17: stloc.0  */
        loc0 = CILJS.ldelem_ref((((asm0.x6000184(asm0.x6000129(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t0))).vtable)["asm0.x6000139"])())(asm0.x6000184(asm0.x6000129(CILJS.new_handle((asm0)["System.RuntimeTypeHandle"](),t0)))),(0|0));
        /* IL_18: ldloc.0  */
        st_0C = loc0;
        /* IL_19: ldstr Hello */
        ...
        st_0F = asm0.x6000193(st_0C,st_0D,st_0E);
