...
asm.x6000001_ = function Main()
{
    ...
    asm0.x6000072(CILJS.makeBox(loc0.X,t1));
    /* IL_19: nop  */
    /* IL_1A: ldloc.0  */
    /* IL_1B: ldfld Int32 Y */
    ...
    asm0.x6000072(CILJS.makeBox(loc0.Y,t1));
    /* IL_2A: nop  */
    /* IL_2B: ret  */
...
asm.S = CILJS.declareType(
    ...
    function (type)
    {
        ...
        CILJS.initType(type,asm,"S",true,false,false,false,false,[],[],asm0["System.ValueType"](),CILJS.isInstValueType(type),Array,"asm1.t2000002",new (asm1.S())());
...
CILJS.declareAssembly("Struct.cs.ciljs",asm);
