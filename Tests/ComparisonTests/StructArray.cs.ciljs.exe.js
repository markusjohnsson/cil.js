...
asm.x6000002_ = function PrintAsObject(arg0)
{
    ...
    asm0.x6000072(CILJS.make_box((CILJS.cast_class(arg0,t1).jsarr)[0].X,t2));
    /* IL_1C: nop  */
    /* IL_1D: ret  */
...
asm.x6000003 = function Print(arg0)
{
    ...
    asm0.x6000072(CILJS.make_box((arg0.jsarr)[0].X,t0));
    /* IL_17: nop  */
    /* IL_18: ret  */
...
CILJS.declare_assembly("StructArray.cs.ciljs",asm);
