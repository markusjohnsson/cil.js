...
asm.x6000005_ = function Main()
{
    ...
    asm0.x6000072(CILJS.makeBox(asm1.x6000001(loc0,CILJS.newobj(t1,asm1.x6000004,[null])),t2));
    /* IL_1C: nop  */
    /* IL_1D: ret  */
...
asm.B = CILJS.declareType(
    ...
    function (type)
    {
        ...
        CILJS.initType(type,asm,"B",false,false,false,false,false,[],[],asm1["A`1"](asm1.C()),CILJS.isInstDefault(type),Array,"asm1.t2000003",null);
...
CILJS.declareAssembly("GenericBaseClassBug.cs.ciljs",asm);
