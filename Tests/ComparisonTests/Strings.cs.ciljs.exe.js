...
asm.x6000004_ = function Main()
{
    ...
    asm0.x6000073(asm1.x6000006(),CILJS.newArray(t0,0));
    /* IL_11: nop  */
    ...
    asm1.x6000002(loc0,CILJS.newString("300"));
    /* IL_23: nop  */
    /* IL_24: ldloc.0  */
    ...
    asm0.x6000073(loc0["A<X>k__BackingField"],CILJS.newArray(t0,0));
    /* IL_35: nop  */
    /* IL_36: ldloc.0  */
    ...
    asm0.x6000073(asm1.x6000005(loc0["A<X>k__BackingField"]),CILJS.newArray(t0,0));
    /* IL_4C: nop  */
    ...
    asm0.x6000072(CILJS.makeBox(asm0.x60000c3(CILJS.newString("123456789")),t2));
    /* IL_61: nop  */
    /* IL_62: ret  */
...
CILJS.declareAssembly("Strings.cs.ciljs",asm);
