            ...
            try {
                ...
                while (in_block_1){
                    ...
                    switch (__pos__){
                        ...
                        asm0.x6000072(CILJS.make_box(loc2,t1));
                        /* IL_24: nop  */
                        /* IL_25: nop  */
                        case 0x26:
                        /* IL_26: ldloc.1  */
                ...
                while (in_block_1){
                    ...
                    switch (__pos__){
                        ...
                        ((loc3.ifacemap)[t2].x60000dd)(CILJS.convert_box_to_pointer_as_needed(loc3));
                        /* IL_40: nop  */
                        case 0x41:
                        /* IL_41: endfinally  */
...
asm.Iter = CILJS.declare_type(
    ...
    function (type)
    {
        ...
        CILJS.init_type(type,asm,"Iter",false,false,false,false,false,[],[
