...
asm["D`1"] = CILJS.declareType(
    ...
    function (type, T)
    {
        ...
        CILJS.initType(type,asm,"D`1",false,false,false,true,false,[],[],asm0["System.Object"](),CILJS.isInstDefault(type),Array,"asm1.t2000005",null);
...
CILJS.declareAssembly("IsInstGenericClass.cs.ciljs",asm);
